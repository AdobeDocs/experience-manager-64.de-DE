...
+ Erste Schritte {#getting-started}
   ...
   + AEM Forms Reference Collaterals {#aem-forms-reference-collaterals}
      ...
      + [Referenz-Website zur automatischen Versicherungsverlängerung](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
...
+ Installieren und Konfigurieren von AEM Forms {#install-aem-forms}
   ...
   + Installieren von AEM Forms on OSGi {#osgi-installation}
      + [Unterstützte Plattformen für AEM Forms unter OSGi](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
      + [Document Services installieren und konfigurieren](using/install-configure-document-services.md)
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Installieren und Bereitstellen von AEM Forms on JEE mithilfe von JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      + [Nur Document Security-Server installieren und konfigurieren](using/installing-and-configuring-the-document-security-server.md)
      + [Vorbereiten der Installation des AEM Forms-Einzelservers](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [Installieren und Bereitstellen von AEM Forms on JEE für JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [Installieren und Bereitstellen von AEM Forms on JEE für WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      + [Installieren und Bereitstellen von AEM Forms on JEE für WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_64)
      + [Installieren von AEM Forms Workbench](http://help.adobe.com/en_US/AEMForms/6.1/InstallWorkbench/index.html)
      + [Installieren und Konfigurieren von Designer](using/installing-configuring-designer.md)
      + [Vorbereiten der Installation des AEM Forms-Serverclusters](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      + [AEM Forms on JEE auf JBoss-Cluster konfigurieren](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [AEM Forms on JEE auf einem WebLogic-Cluster konfigurieren](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [AEM Forms on JEE auf einem WebSphere-Cluster konfigurieren](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
   + AEM Forms konfigurieren {#configure-aem-forms}
      ...
      + [Konfigurieren des Connector für Microsoft SharePoint](http://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
...
+ Upgrade AEM Forms {#upgrade-aem-forms}
   ...
   + Aktualisierung von AEM Forms auf OSGi {#aem-forms-osgi-upgrade}
   ...
   + Aktualisierung von AEM Forms on JEE {#aem-forms-jee-upgrade}
      + [Vorbereiten der Aktualisierung von AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64)
      + [Checkliste für die Aktualisierung und Planung](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [Aktualisierung auf AEM 6.4 Forms auf JEE](using/upgrade-forms-jee.md)
      + [Aktualisieren von einer AEM Forms-Version auf AEM 6.4 Forms on JEE für JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      ...
      + [Aktualisieren von einer AEM Forms-Version auf AEM 6.4 Forms on JEE für JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [Aktualisierung von einer AEM Forms-Version auf AEM 6.4 Forms on JEE für WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      ...
      + [Aktualisierung von einer AEM Forms-Version auf AEM 6.4 Forms on JEE für WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [Aktualisieren von LiveCycle ES4 SP1 auf AEM Forms on JEE für WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
+ Verwalten von AEM Forms {#manage-administer-aem-forms}
   ...
   + Handling user data {#handling-user-data}
      ...
      + [Forms JEE-Arbeitsabläufe](using/forms-workflow-jee-handling-user-data.md)
   ...
   + Hardening AEM Forms Environment {#hardening-aem-forms-environment}
      ...
      + [Härtung der AEM Forms on JEE-Umgebung](using/hardening-aem-forms-jee-environment.md)
...
+ Adaptive Formulare - Erweitertes Authoring {#adaptive-forms-advanced-authoring}
   ...
   + [Standardmäßige Prüffehlermeldungen für adaptive Formulare](using/standard-validation-error-messages-adaptive-forms.md)
+ Interaktive Kommunikation {#interactive-communications}
   ...
   + [Bedingungen in interaktiver Kommunikation](using/conditions-interactive-communications.md)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [Designer-Lernprogramme](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   + [Designer-Beispiele](http://www.adobe.com/go/learn_aemforms_designer_samples_64)
   + [Designer Grundlagen zur Skripterstellung](http://www.adobe.com/go/learn_aemforms_scriptingBasics_64)
   + [Designer-Skriptreferenz](http://www.adobe.com/go/learn_aemforms_scriptingReference_64)
   + [Designer FormCalc-Referenz](http://www.adobe.com/go/learn_aemforms_formCalc_64)
...
+ Administratorhilfe für AEM Forms on JEE {#administrator-help}
   ...
   + Herstellen einer Verbindung mit einem Inhaltsverwaltungssystem {#connect-content-management-system}
      ...
      + [Connector for IBM Content Manager konfigurieren](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
   ...
   + Arbeiten mit PDF Generator {#work-with-pdf-generator}
      ...
      + [Mehrprozessgestützte Dateikonvertierungen aktivieren](/help/forms/using/admin-help/enabling-multi-threaded-file-conversions.md)
   ...
   + Konfigurieren des Arbeitsablaufs für Formulare{#configure-forms-workflow}
      ...
      + [Suche nach Prozessinstanzen](/help/forms/using/admin-help/searching-process-instances.md)
      + [Konfigurieren von Servereinstellungen](/help/forms/using/admin-help/configuring-server-settings.md)
...
+ Entwicklerreferenz {#developer-reference}
   ...
   + [HTML-Vorlagensprache](https://docs.adobe.com/content/help/en/experience-manager-htl/using/overview.html)
   ...
   + [AEM Forms Java API-Referenz](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/index.html)
   ...
   + Programmieren mit AEM Forms on JEE {#programming-aem-forms-jee}
      + Einführung in die Programmierung mit AEM Forms on JEE {#introduction-programming-aem-forms-jee}
         ...
         + [AEM Forms-Prozesse](developing/aem-forms-processes.md)
         + [Dienstcontainer](developing/service-container.md)
      + Kurzanleitung zur Java-API - Codebeispiele {#java-api-quick-start-code-examples}
         + [Application Manager Client JavaAPI-Kurzanleitung (SOAP)](developing/application-manager-client-java-api.md)
         + [Application Manager Service JavaAPI-Kurzanleitung (SOAP)](developing/application-manager-service-java-api.md)
         + [Assembler Service Java API QuickStart(SOAP)](developing/assembler-service-java-api-quick.md)
         + [Acrobat Reader DC Extensions-DienstJava API-Kurzanleitung (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
         + [Service APIQuick-Starts sichern und wiederherstellen](developing/backup-restore-service-api-quick.md)
         + [Barcoded Forms Service Java APIQuick Start(SOAP)](developing/barcoded-forms-service-java-api.md)
         + [Komponenten und Dienste - Java APIQuick Start(SOAP)](developing/components-services-java-api-quick.md)
         ...
         + [Document Management-Dienst (nicht mehr unterstützt)Java-API-Schnellstart (SOAP)](developing/document-management-service-deprecated-java.md)
         + [Document Security Service JavaAPI-Kurzanleitung (SOAP)](developing/document-security-service-java-api.md)
         ...
         + [JavaAPI Kurzanleitung zum Formulardatenintegrationsdienst (SOAP)](developing/form-data-integration-service-java.md)
         ...
         + [Aufruf-API - Schnellstarts](developing/invocation-api-quick-starts.md)
         + [LiveCycleProcess Java API(SOAP)Schnellstart](developing/livecycleprocess-java-api-soap-quick.md)
      ...
      + Ausführen von Dienstvorgängen mit APIs {#performing-service-operations-using-apis}
         ...
         + [Programmgesteuertes Disassemblieren von PDF-Dokumenten](developing/programmatically-disassembling-pdf-documents.md)
         ...
         + [Erstellen von PDF-Dokumenten mit übermittelten XML-Daten](developing/creating-pdf-documents-submitted-xml.md)
         ...
         + [Wiedergeben interaktiver PDF-Formulare](developing/rendering-interactive-pdf-forms.md)
         ...
         + [Erstellen von Dokumentausgabestreams](developing/creating-document-output-streams.md)
         ...
         + [Vorbereiten von AEM Forms für Sicherung](developing/preparing-aem-forms-backup.md)
         ...
         + [Dokumente mit Richtlinien schützen](developing/protecting-documents-policies.md)
