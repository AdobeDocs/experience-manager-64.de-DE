...
Übergeben Sie beim Zusammenstellen eines PDF-Portfolios eine NAV-Datei (eine Navigatordatei) an den Assembler-Dienst. Die an den Assembler-Dienst übergebene NAV-Datei hängt davon ab, welche Art von PDF-Portfolio erstellt werden soll. Übergeben Sie zum Erstellen eines Layouts für *Ein Bild* beispielsweise die Datei &quot;AdobeOnImage.nav&quot;. Sie können NAV-Dateien im folgenden Ordner suchen:
...
1. Speichern Sie das assemblierte Portfolio.
   ...
   * Rufen Sie die `com.adobe.idp.Document` `copyToFile` Objektmethode auf, um das PDF-Portfolio zu extrahieren.
