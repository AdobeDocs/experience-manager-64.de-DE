...
<table> 
 ...
 <tbody>
  <tr> 
   <td><p>1</p></td> 
   <td><p>Das <code>GetLoanForm</code> Java-Servlet wird von einer HTML-Seite aufgerufen. </p></td> 
  </tr> 
  <tr> 
   <td><p>2</p></td> 
   <td><p>Das <code>GetLoanForm</code> Java-Servlet verwendet die Forms-Dienst-Client-API, um das Darlehensformular an den Client-Webbrowser zu rendern. (Siehe Interaktives PDF-Formular mit der Java-API <a href="#render-an-interactive-pdf-form-using-the-java-api">rendern</a>.)</p></td> 
  </tr> 
  <tr> 
   <td><p>3</p></td> 
   <td><p>Nachdem der Benutzer das Kreditangebot ausgefüllt und auf die Senden-Schaltfläche geklickt hat, werden die Daten an das <code>HandleData</code> Java-Servlet gesendet. (Siehe <i>"Kreditformular"</i>.)</p></td> 
  </tr> 
  <tr> 
   <td><p>4</p></td> 
