...
* **AEM-Grundlagen**
   ...
   AEM QuickStart-, AEM Forms Add-On-Paket und Referenz-Website-Pakete. See [AEM Forms releases](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html) for add-on and reference sites packages details.

* **Einen SMTP-Dienst** Sie können einen beliebigen SMTP-Dienst verwenden.

* **Adobe Sign Developer-Konto und Adobe Sign API-Anwendung**

   Um digitale Signaturfunktionen verwenden zu können, ist ein Adobe Sign-Entwicklerkonto erforderlich. Siehe[ Adobe Sign](https://acrobat.adobe.com/us/en/why-adobe/developer-form.html).
...
* Eine ausgeführte Instanz von AEM 6.4 mit Add-On-Paket für Forms. Weitere Informationen finden Sie unter [Installation und Konfiguration von AEM Forms](https://helpx.adobe.com/experience-manager/6-3/forms/using/installing-configuring-aem-forms-osgi.html).
...
Geben Sie für AEM Forms-Referenzseiten im AEM DS-Einstellungsdienst die URL des Servers für die Veröffentlichung anstelle der URL des Verarbeitungsservers an.
...
1. Wechseln Sie in Ihrer Microsoft Dynamics-Instanz zu **[!UICONTROL Solutions]** im Menü **[!UICONTROL Einstellungen]** und klicken Sie auf **[!UICONTROL Importieren]**. Wählen Sie das Paket aus und importieren Sie es.
...
Konfigurieren Sie den OAuth-Cloud-Dienst in AEM Forms, um die Kommunikation zwischen AEM Forms und Microsoft Dynamics zu aktivieren. Führen Sie die folgenden Schritte aus, um den OAuth Cloud-Dienst für Autoren- und Veröffentlichungsinstanzen von AEM zu konfigurieren:

1. On AEM author instance, go to **[!UICONTROL Tools > Cloud Services > Data Sources > global]**. Tippen Sie auf das Symbol **[!UICONTROL Refsite Dynamics Integration]** und dann auf **[!UICONTROL Eigenschaften]**.
...
1. Go to **[!UICONTROL Forms > Data Integrations > We.Finance]**. Wählen Sie Auto Insurance (Dynamics) und klicken Sie auf Edit. Microsoft Dynamics-Entitäten werden unter der Registerkarte Data Sources aufgeführt. Warten Sie, bis alle Entitäten von Microsoft Dynamics abgerufen und unter der Registerkarte &quot;Datenquellen&quot;aufgelistet wurden.
1. Select the **[!UICONTROL AutoInsuranceRenewal entity]** and click **[!UICONTROL Test Model Object]**. In the input request section, specify the value for customer ID as “900001” and click **[!UICONTROL Test]**. Im Bereich &quot;Ausgabe&quot;werden die Datensätze angezeigt, die von Microsoft Dynamics für die Kunden-ID 900001 abgerufen wurden.
1. In the input request section, specify the value for customer ID as “900001” and click **[!UICONTROL Test]**. Im Bereich &quot;Ausgabe&quot;werden die Datensätze angezeigt, die von Microsoft Dynamics für die Kunden-ID 900001 abgerufen wurden.
...
1. Konfigurieren Sie den **[!UICONTROL Status Update Scheduler-Ausdruck]** als **0 0/2 &amp;ast; &amp;ast; &amp;ast; ?**.
...
1. Go to **[!UICONTROL Tools > Cloud Services > Adobe Sign > global]**. Wählen Sie **[!UICONTROL AEM Forms Reference Site Sign]** und tippen Sie auf **[!UICONTROL Properties]**.

   >[!CAUTION]
   >
   >Vergewissern Sie sich, dass die URL https://[host]:[ssl_port]/mnt/overlay/adobesign/cloudservices/adobesign/properties.html zur Liste der Umleitungs-URL der OAuth-Konfiguration der Adobe Sign API-Anwendung hinzugefügt wird.
...
1. (Nur **Autoreninstanz**) Gehen Sie zu **[!UICONTROL Tools** >**Cloud-Dienste**>**Datenquellen**> **global]**. Wählen Sie **[!UICONTROL Ruhezeit]** und tippen Sie auf **[!UICONTROL Eigenschaften]**. Tippen Sie auf **[!UICONTROL Authentifizierungseinstellungen]** und legen Sie den **[!UICONTROL Authentifizierungstyp]** auf **[!UICONTROL Grundlegende Authentifizierung]** fest. Geben Sie `admin`/ `admin`als Benutzernamen/Kennwort für den Zugriff auf den Dienst an. Tap **[!UICONTROL Save &amp; Close]**.
...
1. Navigieren Sie zu https://&lt;*Host*>:&lt;*Anschluss*>/system/console/configMgr und führen Sie folgende Schritte aus:
   ...
   * Wählen Sie im Dialogfeld &quot;Analytics-Konfiguration von AEM Forms&quot;im **[!UICONTROL SiteCatalyst-Framework]** die Option we-finance(we-finance) oder we-gov(we-gov).
...
1. Navigieren Sie zum Forms Manager unter https://&lt;Host>:&lt;Anschluss>/aem/forms und führen Sie die folgenden Schritte aus:
   ...
   * Klicken Sie in der Aktions-Symbolleiste auf Analyse aktivieren. Nachdem Sie die Analyse für das Formular aktiviert haben, klicken Sie auf Analysebericht. Sie können sehen, dass ein leerer Bericht generiert wurde. Nachdem ein leerer Bericht generiert wurde, müssen Sie Seed-Daten bereitstellen, die mit refsite-Paket versandt werden, um einen Analysebericht für Demozwecke zu erstellen.
   Referenzseiten bieten Analyseberichte mit Seed-Daten für Kreditkarten-, Hypotheken- und Kindergeld-Anwendungsfälle. Informationen zur Konfiguration von Seed-Daten finden Sie unter [Website-Umgehungslösung](/help/forms/using/finance-reference-site-walkthrough.md) für We.Finance und [Website-Umgehungslösung](/help/forms/using/gov-reference-site-walkthrough.md)für We.Gov-Referenz.
...
1. Geben Sie im Feld **[!UICONTROL Target-URLs]** die URL für AEM Forms ein. For example: https://&lt;*hostname*>:&lt;*port*>.

1. Klicken Sie auf **[!UICONTROL Speichern]**.

Anwendungsfälle für Kreditkartenanträge und Hypothekenanträge zeigen, wie A/B-Tests durchgeführt werden und wie ein Bericht zu Demozwecken dargestellt wird. exemplarische Vorgehensweisen finden Sie auf der Website [We.Finance-Referenz](/help/forms/using/finance-reference-site-walkthrough.md).
