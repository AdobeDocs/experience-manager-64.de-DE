...
1. Klicken Sie mit der rechten Maustaste auf den Unterordner /etc/clientlibs und dann auf **[!UICONTROL Erstellen > Knoten erstellen]**. Enter a name (here afTestRegistration), specify the type of node as cq:ClientLibraryFolder, and click **[!UICONTROL OK]**.
...
1. Right-click the test node (here **afTestRegistration)** and then click **[!UICONTROL Create > Create File]**. Nennen Sie die Datei js.txt und klicken Sie auf **[!UICONTROL OK]**.
...
1. Right-click the test node (here **afTestRegistration)** and click **[!UICONTROL Create > Create File]**. Nennen Sie die Datei init.js und klicken Sie auf **[!UICONTROL OK]**.
...
1. Klicken Sie auf **[!UICONTROL Erstellen]** >**Knoten erstellen**, um einen Knoten unter dem clientlib-Ordner für jedes Formular zu erstellen, das Sie testen möchten. In diesem Beispiel wird ein Knoten mit dem Namen **testForm** verwendet, um ein adaptives Formular mit dem Namen **testForm** zu testen. `.`Geben Sie die folgenden Eigenschaften an und klicken Sie auf **[!UICONTROL OK]**:
