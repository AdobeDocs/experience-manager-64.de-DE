  ...
  <tr>
   ...
   <td>Gibt die zugehörigen Assets an, die zusammen mit den Suchergebnissen abgerufen werden sollen. Sie können eine der folgenden Optionen auswählen, um zugehörige Assets abzurufen:
    <ul>
     ...
     <li><strong>SOFORT</strong>: Ruft Assets ab, die sich direkt auf Suchergebnisse beziehen.</li>
     <li><strong>ALL</strong>: Direktes und indirekt verknüpftes Asset abrufen.</li>
    </ul> </td>
  </tr>
  <tr>
   <td>maxSize</td>
