...
>[!NOTE]
>
>Um die Detailseite der Aufgabe mit Aufgaben anzupassen, die im Register **Beginn-Prozess **von AEM Forms Workspace erstellt wurden, fügen Sie die neuen Informationen zu `/apps/ws/js/runtime/templates/startprocess.html` hinzu.
>
