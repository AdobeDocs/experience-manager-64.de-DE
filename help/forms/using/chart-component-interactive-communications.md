...
1. Tap the chart component in the Interactive Communication editor and from the Component toolbar select **[!UICONTROL Configure (]** ![configure_icon](assets/configure_icon.png)).
   ...
   **** Abbildung: *Grundlegende Eigenschaften eines Linientypdiagramms im Druckkanal*
...
* **[!UICONTROL Beschriftungsrichtung]** (in diesem Beispiel nur für das Spaltentypdiagramm im Druckkanal) - in diesem Beispiel `Tilt Left`

* **[!UICONTROL QuickInfo]** , die beim Mauszeiger über eine Kosten angezeigt wird (nur Webkanal) - in diesem Beispiel `${x}: $ ${y}`, das als [Ausgabenbeschriftung angezeigt wird: $ Amount] (Beispiel: Themenparkbesuch: $ 315)

![](assets/chartprintchannel.png) Spaltendiagramm in der Druckausgabe einer interaktiven Kommunikation **** Abbildung: *Spaltendiagramm in der Druckausgabe einer interaktiven Kommunikation*

******A. Y-Achse - Aus der Eigenschaft des Formulardatenmodells und der Eigenschaft Titel abgerufener Betrag auf Betrag ($)** B. Beschriftungsrichtung der X-Achse auf &quot;Neigung links **C.** X&quot;-Achse - Ausgabenbeschreibung, die von der Eigenschaft des Formulardatenmodells und der Eigenschaft &quot;Titel&quot;auf &quot;Kosten&quot;abgerufen wird

![](assets/chartwebchannel.png) Ringdiagramm in der Webausgabe einer interaktiven Kommunikation **** Abbildung: Ringdiagramm *in der Webausgabe einer interaktiven Kommunikation*
...
![](assets/creditcarddatalinechartcopy.png) Liniendiagramm ohne Funktion mit drei Transaktionen **&quot;Bed and Breakfast&quot;** Abbildung: *Liniendiagramm ohne Funktion mit drei &quot;Bed and Breakfast&quot;-Transaktionen*
...
**X-Achse > Richtung** der Beschriftung im Diagramm im Druckkanal. Wenn Sie die Richtung der Beschriftung als &quot;Benutzerdefinierte Drehung&quot;wählen, wird das Feld &quot;Benutzerdefinierter Drehwinkel (Grad)&quot;angezeigt. Im Feld „Benutzerdefinierter Drehwinkel (Grad)“ können Sie den Drehwinkel in Schritten von 15 Grad wählen.

**Y-Achse > Titel** Gibt den Titel für die Y-Achse an.

**** Y-Achse > Datenmodellobjekt und -amp;ast; Gibt das auf der y-Achse abzuzeichnende Collection-Element des Formulardatenmodells an. Im Druckkanal sollte das Datenmodellobjekt für die Y-Achse vom Typ Number sein.
...
**Obligatorischer Seitenumbruch vor (nur Druckkanal)** Wählen Sie diese Option, um vor dem Diagramm einen obligatorischen Seitenumbruch hinzuzufügen und das Diagramm auf eine neue Seite zu setzen.

**Obligatorischer Seitenumbruch nach (nur Druckkanal)** Wählen Sie diese Option, um nach dem Diagramm einen obligatorischen Seitenumbruch hinzuzufügen und den Inhalt nach dem Diagramm auf eine neue Seite zu setzen.
