...
1. Im **Build-Einstellungen** Registerkarte, klicken Sie auf **Alle** und klicken Sie anschließend auf **Kombiniert**.
...
1. Wählen Sie die entsprechende **Code Signing Identity** und klicken Sie auf **Nächste**. Klicken **Zulassen** , um die Signatur anzuwenden.
...
1. Im **Titel** -Feld AEM Forms angeben.
1. Klicken **Speichern** und schließen Sie Xcode.
