...
1. Klicken Sie auf **OK**. An das Formular wird eine Textdatei mit Ihrer Notiz angehängt . Sie können eine Notiz aktualisieren, indem Sie darauf klicken und den Text direkt ändern. Sie können eine Notiz löschen, indem Sie auf die **Löschen** button ![Bild eines Papierkorbs](assets/icondelete.png) neben der Notiz.
...
1. Klicken Sie auf **OK**. Die Datei wird an das Formular angehängt. Sie können eine Datei löschen, indem Sie auf **Löschen** button ![Bild eines Papierkorbs](assets/icondelete.png) neben dem Anhang.
...
1. Klicken **Speichern** in der linken unteren Ecke einer Registerkarte. Das Formular wird zur Kategorie „Entwurf“ auf der Seite „Aufgaben“ hinzugefügt. Alle Änderungen, die Sie am Formular vorgenommen haben, werden gespeichert.
