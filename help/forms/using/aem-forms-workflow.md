...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Wählen Sie die Option <span class="uicontrol">Workflow </span>aus. </td> 
  </tr> 
  <tr> 
...
1. Tippen Sie auf **[!UICONTROL Erweitert]**. Geben Sie einen Wert für das folgende Feld ein und tippen Sie auf **[!UICONTROL Erstellen]**. Damit ist der überwachte Ordner so konfiguriert, dass er einen Arbeitsablauf startet. Wenn nun eine Datei im Eingabeverzeichnis des überwachten Ordners abgelegt wird, wird der angegebene Workflow ausgelöst.
