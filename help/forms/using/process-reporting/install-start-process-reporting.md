...
Weitere Informationen zu den vordefinierten Berichten finden Sie unter [Vordefinierte Berichte in Process Berichte](pre-defined-reports-in-process-reporting.md).
