...
**AEM Forms on OSGi:** Bei einer AEM Forms in OSGi-Umgebung handelt es sich um ein standardmäßiges AEM-Autor- oder AEM-Veröffentlichungs-Paket, auf dem das AEM Forms-Paket bereitgestellt ist. Sie können AEM Forms unter OSGi in einer [Einzelserver-Umgebung, Farm- und Cluster-Setups](/help/sites-deploying/recommended-deploys.md). Die Clustereinrichtung ist nur für AEM-Autoreninstanzen verfügbar.
...
* **HTML Workspace-Hosting**: Eine Verarbeitungsinstanz hostet das Frontend für HTML Workspace. HTML Workspace bietet die Benutzeroberfläche für die zugehörige Aufgabenzuweisung/Gruppenzuweisung für Prüfungs- und Genehmigungsprozesse.
