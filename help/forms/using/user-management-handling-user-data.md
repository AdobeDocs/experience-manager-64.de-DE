...
Die Benutzerverwaltung ist eine AEM Forms JEE-Komponente, die das Erstellen, Verwalten und Autorisieren von AEM Forms-Benutzern für den Zugriff auf AEM Forms ermöglicht. Benutzerverwaltung verwendet Domains als Ordner zum Abrufen von Benutzerinformationen. Die folgenden Datenbanktypen werden unterstützt:
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Speichert personenbezogene Daten (PII) von Nutzern. Es enthält einen Eintrag für jeden Benutzer aus lokalen, Unternehmens- und Hybrid-Domains.</td> 
  </tr> 
  <tr> 
...
User Management-Daten für Benutzer, die mindestens einmal auf die Forms-Programme unter `https://[*server*]:[*host*]/lc` zugegriffen haben, werden ebenfalls im AEM-Repository gespeichert.
