...
>[!NOTE]
>
>Die Dateitypeinstellungen sind nicht für die Fallback-Konvertierer wie Acrobat zum HTML auf PDF, Microsoft PowerPoint, Microsoft Word und Microsoft Excel verfügbar.
...
**Ersatzkonverter versuchen:** PDF Generator kann entweder Java™ oder Acrobat verwenden, um Bilddateien in PDF-Dateien zu konvertieren. Wenn diese Option aktiviert ist und eine Konvertierung fehlschlägt oder das angegebene Timeout-Limit erreicht, versucht PDF Generator die Konvertierung mithilfe der alternativen Methode durchzuführen. Wenn die alternative Methode fehlschlägt oder das angegebene Zeitlimit erreicht, wird eine Ausnahme in die Protokolldatei geschrieben.
...
PDF Generator unterstützt die Möglichkeit, ein Video für Adobe Flash (SWF oder FLV-Datei) zu senden und eine PDF-Datei mit einem darin eingebetteten Video für Adobe-Flash zu erstellen. Für diese Konvertierung muss Adobe Flash Player nicht auf dem Formularserver installiert sein. Anweisungen zum Zugriff auf diese Option finden Sie unter [Dateitypeinstellungen erstellen oder bearbeiten](configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
Wenn Ihr PDF-Dokument Grafiken enthält, die Transparenz enthalten, können Sie die PDF Optimizer-Einstellungen verwenden, um die Transparenz zu reduzieren und die Dateigröße zu reduzieren.
...
**Transparenzstufe** Legt die Menge an Vektorinformationen fest, die beibehalten wird. Bei höheren Einstellungen werden mehr Vektorobjekte beibehalten, während bei niedrigeren Einstellungen mehr Vektorobjekte gerastert werden. Zwischeneinstellungen bewahren einfache Bereiche in Vektorform auf und rastern komplexe Bereiche. Wählen Sie die niedrigste Einstellung aus, um alle Grafiken zu rastern.

>[!NOTE]
>
>Die vorgenommene Rasterung hängt von der Komplexität der Seite und den Arten der überlappenden Objekte ab.
...
* **Eingebettete Seitenminiaturen verwerfen**: Entfernt eingebettete Seitenminiaturansichten. Diese Option ist für große Dokumente nützlich, bei denen es lange dauern kann, bis Seitenminiaturansichten gezeichnet werden, nachdem Sie auf die Schaltfläche &quot;Seiten&quot;geklickt haben.
* **Glatte Linien in Kurven konvertieren**: Reduziert die Anzahl der Steuerpunkte, die zum Erstellen von Kurven in CAD-Zeichnungen verwendet werden, was zu kleineren PDF-Dateien und einer schnelleren Bildschirmdarstellung führt.
...
* **Erkennen und Zusammenführen von Bildfragmenten**: Sucht nach Bildern oder Masken, die in dünne Scheiben fragmentiert sind, und versucht, die Scheiben in einem Bild oder einer Maske zusammenzuführen.
...
Diese Optionen bestimmen, wie Microsoft PowerPoint-Dateien konvertiert werden. Anweisungen zum Zugriff auf diese Optionen finden Sie unter [Dateitypeinstellungen erstellen oder bearbeiten](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Multimedia in PDF Multimedia konvertieren]**: Konvertiert Multimedia nach Möglichkeit in PDF Multimedia. Standardmäßig ist diese Option aktiviert.

**[!UICONTROL Konvertieren von Lautsprecherhinweisen]**: Wandelt Lautsprechernotizen in PDF um.
...
**[!UICONTROL PDF/A-1a-kompatible Datei erstellen]**: Erzwingt, falls ausgewählt, die Verwendung der Einstellung PDF/A-1b:2005 RGB Adobe PDF .
...
Diese Optionen bestimmen, wie AutoCAD-Dateien konvertiert werden. Anweisungen zum Zugriff auf diese Optionen finden Sie unter [Dateitypeinstellungen erstellen oder bearbeiten](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Modellbereich in 3D konvertieren]**: Wenn diese Option aktiviert ist, wird das Modellraum-Layout in eine 3D-Anmerkung auf der PDF konvertiert.

**[!UICONTROL Links zu Adobe PDF hinzufügen]**: Wenn diese Option aktiviert ist, werden alle Links beibehalten.

**[!UICONTROL Quelldatei an Adobe PDF anhängen]**: Fügt die Quelldatei der PDF-Datei als Anlage hinzu.

**[!UICONTROL PDF/A-1b-kompatible Datei erstellen]**: Erzwingt die Verwendung der Adobe PDF-Einstellung PDF/A-1b.

**[!UICONTROL Alle Ebenen konvertieren]**: Standardmäßig konvertiert PDF Generator nur die Standardebene von AutoCAD-Dateien in PDF anstelle aller Ebenen in der Datei. Wählen Sie diese Option, um alle Ebenen der Datei zu konvertieren.

**[!UICONTROL Skalierungsinformationen einbetten]**: Behält Skalierungsinformationen der Zeichnungen bei.

**[!UICONTROL Aktuelles Layout konvertieren]**: Nimmt nur das aktuelle Layout in die PDF auf.

**[!UICONTROL Liste der zu konvertierenden AutoCAD-Layouts]**: Eine AutoCAD-Zeichnung kann mehrere Layouts aufweisen. Wenn dieses Feld leer ist, sind alle Layouts in der AutoCAD-Zeichnung im generierten PDF-Dokument enthalten. Um eine Teilmenge der Layouts selektiv zu konvertieren, geben Sie eine kommagetrennte Liste mit Layoutnamen an.

## OpenOffice-Einstellungen {#openoffice-settings}

Diese Optionen bestimmen, wie OpenOffice-Dateien konvertiert werden. Anweisungen zum Zugriff auf diese Optionen finden Sie unter [Dateitypeinstellungen erstellen oder bearbeiten](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
**Dateinamenerweiterungen**: Geben Sie die Dateinamenerweiterungen für Dateitypen an, die durch Kommas getrennt sind und für diese Anwendung akzeptiert werden. Der Standardwert lautet `odt,odp,ods,odg,odf,sxw,sxi,sxd`. Setzen Sie keinen Punkt vor und kein Leerzeichen zwischen die Erweiterungen.
...
**Forms im Format übermitteln**: Erstellt ein PDF-Formular, das vom Benutzer des PDF-Dokuments ausgefüllt und gedruckt werden kann.
