...
**Dateimuster:** Gibt das Muster für eingehende Dateianhänge an, die vom Anbieter akzeptiert werden. Dazu gehören Dateien mit bestimmten Erweiterungen (&amp;ast;.dat, &amp;ast;.xml), bestimmte Namen (Daten) oder zusammengesetzte Ausdrücke im Namen und in der Erweiterung (&amp;ast;.[dD][aA][Tt]).
...
1. Geben Sie im Feld &quot;SMTP User&quot;das Benutzerkonto ein, das der E-Mail-Anbieter verwenden soll, wenn er E-Mails zu Ergebnissen und Fehlern sendet. Dieses Benutzerkonto kann mit dem für Posteingangsbenutzer verwendeten Wert übereinstimmen.
