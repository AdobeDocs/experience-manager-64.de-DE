...
**SMTP-Authentifizierung:** Wählen Sie aus, ob die Benutzerauthentifizierung erforderlich ist, um eine Verbindung zum SMTP-Server herzustellen.
...
**Andere Eigenschaften:** Paare aus Eigenschaftenname und -wert, die an den JNDI-Dienstleister übergeben werden können. Diese Eigenschaften sind von der Implementierung und Konfiguration des verwendeten Anbieters abhängig. 
...
**Live-Zeit:** Dauer (in Sekunden), die dieses Bereitstellungs-Profil gültig und auf dem Client zwischengespeichert ist. Der Standardwert ist 86400 (24 Stunden). Wenn eine Clientanwendung mit dem Server synchronisiert und die angegebene Zeitdauer abgelaufen ist, fordert die Clientanwendung vom Server ein neues Bereitstellungs-Profil an.
...
**Aufgaben-Anwendung:** Aktiviert die Funktion &quot;Aufgaben&quot;in den mobilen Clientanwendungen. Wenn diese Option aktiviert ist, können Benutzer auf ihre Listen zur Aufgabe und auf vollständige Aufgaben von ihren Mobilgeräten aus zugreifen.
...
**Ausführen von Dokument-JavaScript-Skripten:** Gibt an, ob Dokument-JavaScript-Skripten während der Signaturvorgänge ausgeführt werden. Der Standardwert lautet false.
...
**Sperrungsüberprüfungsreihenfolge:** Gibt die Reihenfolge der Sperrüberprüfung an, in der die Überprüfung sowohl über die Liste der Zertifikatsperrung (CRL) als auch über das Online-Zertifikatstatusprotokoll (OCSP) möglich ist. Der Standardwert ist OCSPFirst.
...
**Duplikat-Dateinamen überschreiben:** Eine boolesche Zeichenfolge, die angibt, ob die Ergebnisdateinamen des Duplikats durch den überwachten Ordner überschrieben werden und ob Dokumente mit demselben Namen überschrieben werden sollen.
