...
**Speicherort des Ordners für Systemschriftarten** Geben Sie den Pfad zum Ordner &quot;Schriftarten&quot;ein, den Ihr Betriebssystem bereitgestellt hat. Es können mehrere Ordner hinzugefügt werden, die durch ein Semikolon **;** getrennt sind.
...
**Aktivieren Sie** WSDLSWählen Sie diese Option, um die WSDL-Generierung (Web Service Definition Language) für alle Dienste zu aktivieren, die zu AEM Formularen gehören.
