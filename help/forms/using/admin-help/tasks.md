...
**** Eskalation: Eine vordefinierte Zeitspanne (wie in der Benutzeraktion in Workbench festgelegt) ohne Benutzerinteraktion und ein anderer Benutzer wurde die Aufgabe zugewiesen.

**** Besprechen: Der Aufgabenbesitzer hat diese Aufgabe an einen anderen Benutzer weitergeleitet, der das Formular öffnen, Daten speichern, die Anlagen und Hinweise ändern kann, den Schritt jedoch nicht abschließen kann. Der Benutzer muss die Aufgabe an den Aufgabenbesitzer zurückgeben, der sich mit dem Benutzer besprochen hat.
