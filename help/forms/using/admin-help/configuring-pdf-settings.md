...
**Drucken mit hoher Qualität:** Erstellt PDF-Dateien für eine Ausgabe mit hoher Qualität. Diese Einstellung dient zum:
...
**Überdimensionierte Seiten:** Erstellt PDF-Dokumente, die für eine zuverlässige Anzeige und Druckausgabe technischer Zeichnungen größer als 200 x 200 Zoll geeignet sind. Erstellte PDF-Dokumente können in Adobe Acrobat Professional und in Acrobat Standard Version 7 oder höher sowie Adobe Reader 7 oder höher geöffnet werden.

**PDF/A-1B 2005 CMYK/PDF/A-1B 2005 RGB:** Prüft eingehende Aufträge auf Einhaltung des ISO-Standards für die Langzeitarchivierung (Archivierung) elektronischer Dokumente und erstellt PDF/A-Dateien nur bei Übereinstimmung. Diese Dateien dienen hauptsächlich zur Archivierung. Kompatible Dateien dürfen nur Text, Rasterbilder und Vektorobjekte und keine Verschlüsselung oder Skripte enthalten. Darüber hinaus müssen alle Schriftarten so eingebettet sein, dass die Dokumente ihrer Erstellung entsprechend geöffnet und angezeigt werden können. PDF/A 1b verwendet PDF 1.4 und konvertiert alle Farben je nach ausgewähltem Standard entweder in CMYK oder in RGB. Mithilfe dieser Einstellungsdatei erstellte PDF-Dateien können in Acrobat 5 und Acrobat Reader 5 und höher geöffnet werden. Weitere Informationen zu PDF/A finden Sie unter Adobe und Branchenstandards.

**PDF/X-1a 2001:** Prüft eingehende Aufträge auf PDF/X-1a-Kompatibilität und erstellt PDF-Dateien nur bei Übereinstimmung. PDF/X-1a ist ein ISO-Standard für den Austausch grafischer Inhalte. PDF/X-1a erfordert, dass alle Schriftarten eingebettet, die entsprechenden PDF-Felder angegeben und Farben entweder als CMYK oder Volltonfarben angezeigt werden. PDF-Dateien, die die PDF/X-1a-Anforderungen erfüllen, werden für eine bestimmte Ausgabebedingung eingerichtet (z. B. für den Web-Offset-Druck gemäß Specifications Web Offset Publications [SWOP]). Weitere Informationen zu PDF/X finden Sie unter Adobe und Branchenstandards.

**PDF/X-3 2002:** Prüft eingehende Aufträge auf PDF/X-3-Kompatibilität und erstellt PDF-Dateien nur bei Übereinstimmung. Ebenso wie PDF/X-1a ist PDF/X-3 ein ISO-Standard für den Austausch grafischer Inhalte. Der Hauptunterschied ist, dass PDF/X-3 geräteunabhängige Farben unterstützt.

**Druckqualität:** Erstellt PDF-Dateien für die Druckproduktion in hoher Qualität (z. B. auf einem Bildbelichter oder einem Plattenbelichter). In diesem Fall spielt die Dateigröße keine Rolle. Ziel ist die Erhaltung sämtlicher Informationen in einer PDF-Datei, die ein Akzidenzdrucker oder Druckvorstufen-Dienstleister zum ordnungsgemäßen Drucken des Dokuments benötigt. Die dazugehörigen Optionen dienen zum:
...
**Komprimierung auf Objektebene:** Fasst kleine Objekte (von denen jedes selbst nicht komprimierbar ist) in Streams zusammen, die dann effizient komprimiert werden können.
...
**Einheiten:** Einheiten, die für die Breite und Höhe verwendet werden sollen
...
**Glätten:** Glättet gezackte Ränder in Schwarzweißbildern. Wählen Sie „2 Bit“, „4 Bit“ oder „8 Bit“, um 4, 16 oder 256 Graustufen anzugeben. (Dieses Verfahren kann bewirken, dass kleine Schriftgrade oder dünne Linien unklar aussehen.)
...
**Beibehalten:** bedeutet, dass der Intent auf dem Ausgabegerät und nicht in der PDF-Datei angegeben wird. Bei vielen Ausgabegeräten ist „Relativ farbmetrisch“ die Standardbedingung.

**Wahrnehmungsorientiert:** Behält die relativen Farbwerte unter den ursprünglichen Pixeln bei, während sie der Ziel-Farbskala zugeordnet werden. Bei dieser Methode bleibt die optische Beziehung zwischen Farben erhalten, obgleich die Farbwerte selbst sich ggf. ändern.
...
**CMYK-Werte für kalibrierte CMYK-Farbräume beibehalten:**  Wenn diese Option ausgewählt ist, werden geräteunabhängige CMYK-Werte als geräteabhängige (DeviceCMYK) Werte behandelt, geräteunabhängige Farbräume werden verworfen und PDF/X-1a-Dateien verwenden den Wert &quot;Alle Farben in CMYK konvertieren&quot;. Falls nicht ausgewählt, werden geräteunabhängige Farbräume in CMYK konvertiert, wenn das Farbmanagement auf „Alle Farben in CMYK konvertieren“ festgelegt ist.
...
**Verläufe in weiche Schattierungen konvertieren:** Konvertiert Farbverläufe in glatte Schattierungen für Acrobat 4 und höher, wodurch PDF-Dateien kleiner werden und die Qualität der endgültigen Ausgabe potenziell verbessert wird. PDF Generator konvertiert Farbverläufe aus Adobe Illustrator, Adobe InDesign, Adobe Freehand MX, CorelDraw, Quark XPress und Microsoft PowerPoint.
...
**EPS-Informationen von DSC beibehalten:**  Behält Informationen wie die ursprüngliche Anwendung und das Erstellungsdatum für eine EPS-Datei bei. Ist diese Option deaktiviert, werden die Größe und Mitte der Seite basierend auf der linken unteren Ecke des linken unteren Objekts und der rechten unteren Ecke des rechten unteren Objekts auf der Seite bestimmt.
...
**Dokumentinformationen von DSC beibehalten:** Behält Informationen wie Titel, Erstellungsdatum und -zeit bei. Wenn Sie eine PDF-Datei in Acrobat öffnen, werden diese Informationen im Bereich „Dokumenteigenschaften“ unter „Beschreibung“ angezeigt.

**Größe der Seite ändern und Grafiken für EPS-Dateien zentrieren:** Zentriert ein EPS-Bild und ändert die Größe der Seite an die Größe des Bildes. Diese Option gilt nur für Aufträge, die aus einer einzelnen EPS-Datei bestehen.
...
**Vorgang &quot;Abbrechen&quot;:** Erstellt nur dann eine PDF-Datei, wenn die PostScript-Datei die PDF/X-Anforderungen der ausgewählten Berichtsoptionen erfüllt und ansonsten gültig ist. Wenn sowohl PDF/X-Berichtsoptionen ausgewählt sind und die PostScript-Datei nur eine Teilmenge der PDF/X-Kriterien erfüllt (z. B. PDF/X-3), erstellt PDF Generator > die konforme Datei.

**Wenn weder TrimBox noch ArtBox angegeben sind:** Verfügbar, wenn Compliance Standard auf der Seite &quot;Standards - Berichterstellung und Kompatibilität&quot;auf eine andere Option als &quot;Ohne&quot;gesetzt ist.
...
**Endformatrahmen auf Medienrahmen mit Versätzen festlegen:** Berechnet Werte in Punkten für das Endformatfeld anhand der Versätze für das Medienfeld der entsprechenden Seiten, wenn weder das Endformatfeld noch das Kunstfeld angegeben ist. Der Endformatrahmen ist stets genau so klein wie oder kleiner als der umgehende Medienrahmen.

**Wenn Anschnittrahmen nicht angegeben:** Verfügbar, wenn auf der Seite &quot;Standards - Berichterstellung und Kompatibilität&quot;die Option &quot;Compliance Standard&quot;auf eine andere Option als &quot;Ohne&quot;eingestellt ist.
...
**Anschnittrahmen auf Endformatrahmen mit Versätzen festlegen:** Berechnet Werte in Punkten für den Anschnittrahmen anhand der Versätze für den Endformatrahmen der jeweiligen Seiten, wenn der Anschnittrahmen nicht angegeben ist. Der Anschnittrahmen ist stets genau so groß wie oder größer als der umgehende Endformatrahmen.

**Standardwerte, wenn nicht im Dokument angegeben:** Diese Option ist verfügbar, wenn auf der Seite &quot;Standards - Berichterstellung und Kompatibilität&quot;die Option &quot;Kompatibilitätsstandard&quot;auf eine andere Option als &quot;Ohne&quot;eingestellt ist.

**Profilname des Ausgabeformats:** Gibt die gekennzeichnete Druckbedingung an, für die das Dokument vorbereitet ist. Wenn in einem Dokument keine Ausgabebedingung angegeben ist, verwendet PDF Generator den in diesem Menü ausgewählten Wert. Sie können einen der angebotenen Namen auswählen oder in das vorgesehene Feld einen Namen eingeben. Wenn Ihr Workflow erfordert, dass das Dokument die Ausgabebedingung angibt, wählen Sie „Ohne“ aus. Dokumente, die nicht die Anforderung erfüllen, bestehen nicht die Kompatibilitätsprüfung.

**Kennung der Ausgabebedingung:** Gibt den Referenznamen an, der von der Registrierung des Profilnamens für die Ausgabebedingung angegeben wurde.

**Ausgabebedingung:** Beschreibt die gewünschte Druckbedingung. Dieser Eintrag kann für den vorgesehenen Empfänger des PDF-Dokuments nützlich sein.
...
**Fortfahren:** Erstellt eine PDF-Datei, auch wenn die PostScript-Datei die Anforderungen des Standards nicht erfüllt.

**Vorgang &quot;Abbrechen&quot;:** Erstellt nur dann eine PDF-Datei, wenn die PostScript-Datei die PDF/A-Anforderungen erfüllt und ansonsten gültig ist.

**Profilname des Ausgabeformats:** Gibt die gekennzeichnete Druckbedingung an, für die das Dokument vorbereitet wurde, und ist für die PDF/A-Konformität erforderlich. Wenn Ihr Workflow es erfordert, dass das Dokument die Ausgabebedingung angibt, wählen Sie „Ohne“ aus. Das Dokument wird bei der Kompatibilitätsüberprüfung fehlschlagen, wenn diese Informationen nicht bereitgestellt werden.

**Ausgabebedingung:** Beschreibt die gewünschte Druckbedingung. Dieser Eintrag ist nicht erforderlich, kann aber verwendet werden, um nützliche Informationen für den vorgesehenen Empfänger der PDF-Datei bereitzustellen.
...
**Einblenden:** Legt fest, welche Bereiche und Registerkarten standardmäßig im Anwendungsfenster angezeigt werden. „Lesezeichenfenster und Seite“ öffnet den Dokumentbereich und die Registerkarte „Lesezeichen“.
...
**Fenstergröße auf Anfangsseite ändern:** Passt das Dokumentfenster entsprechend den Optionen, die Sie unter &quot;Dokumentoptionen&quot;ausgewählt haben, an die Öffnungsseite an.
...
**Einblenden:** Dateiname zeigt den Dateinamen in der Titelleiste des Fensters an. „Dokumenttitel“ zeigt den Dokumenttitel in der Titelleiste des Fensters an.
...
**Menüleiste ausblenden:** Blendet die Menüleiste aus, falls ausgewählt.

**Symbolleisten ausblenden:** Blendet die Symbolleisten aus, falls ausgewählt.
