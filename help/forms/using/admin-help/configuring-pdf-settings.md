...
# Adobe PDF-Einstellungen konfigurieren{#configuring-adobe-pdf-settings}
...
**Oversized Pages:** Erstellt PDF-Dokumente, die für die zuverlässige Anzeige und den Druck von Ingenieurzeichnungen geeignet sind, die größer als 200 x 200 Zoll sind. Erstellte PDF-Dokumente können in Adobe Acrobat Professional und in Acrobat Standard Version 7 oder höher sowie Adobe Reader 7 oder höher geöffnet werden.

**PDF/A-1B 2005 CMYK/PDF/A-1B 2005 RGB:** Überprüft eingehende Aufträge auf Einhaltung des ISO-Standards für die Langzeitarchivierung (Archivierung) elektronischer Dokumente und erstellt PDF/A-Dateien nur bei Übereinstimmung. Diese Dateien dienen hauptsächlich zur Archivierung. Kompatible Dateien dürfen nur Text, Rasterbilder und Vektorobjekte und keine Verschlüsselung oder Skripte enthalten. Darüber hinaus müssen alle Schriftarten so eingebettet sein, dass die Dokumente ihrer Erstellung entsprechend geöffnet und angezeigt werden können. PDF/A 1b verwendet PDF 1.4 und konvertiert alle Farben je nach ausgewähltem Standard entweder in CMYK oder in RGB. Mithilfe dieser Einstellungsdatei erstellte PDF-Dateien können in Acrobat 5 und Acrobat Reader 5 und höher geöffnet werden. Weitere Informationen zu PDF/A finden Sie unter Adobe und Branchenstandards.

**PDF/X-1a 2001:** Überprüft eingehende Aufträge auf Übereinstimmung mit PDF/X-1a und erstellt PDF-Dateien nur bei Übereinstimmung. PDF/X-1a ist ein ISO-Standard für den Austausch grafischer Inhalte. PDF/X-1a erfordert, dass alle Schriftarten eingebettet, die entsprechenden PDF-Felder angegeben und Farben entweder als CMYK oder Volltonfarben angezeigt werden. PDF-Dateien, die die PDF/X-1a-Anforderungen erfüllen, werden für eine bestimmte Ausgabebedingung eingerichtet (z. B. für den Web-Offset-Druck gemäß Specifications Web Offset Publications [SWOP]). Weitere Informationen zu PDF/X finden Sie unter Adobe und Branchenstandards.

**PDF/X-3 2002:** Überprüft eingehende Aufträge auf Übereinstimmung mit PDF/X-3 und erstellt PDF-Dateien nur bei Übereinstimmung. Ebenso wie PDF/X-1a ist PDF/X-3 ein ISO-Standard für den Austausch grafischer Inhalte. Der Hauptunterschied ist, dass PDF/X-3 geräteunabhängige Farben unterstützt.

**Druckqualität:** Erstellt PDF-Dateien für die Druckproduktion in hoher Qualität (z. B. auf einem Bildbelichter oder einer Platine). In diesem Fall spielt die Dateigröße keine Rolle. Ziel ist die Erhaltung sämtlicher Informationen in einer PDF-Datei, die ein Akzidenzdrucker oder Druckvorstufen-Dienstleister zum ordnungsgemäßen Drucken des Dokuments benötigt. Die dazugehörigen Optionen dienen zum:
...
**Einheiten:** Für die Einstellungen für Breite und Höhe zu verwendende Einheiten
...
**Durchschnittliche Neuberechnung auf:** Durchschnittet die Pixel in einem Beispielbereich und ersetzt den gesamten Bereich durch die durchschnittliche Pixelfarbe mit der angegebenen Auflösung.

**Bikubische Neuberechnung auf:** Verwendet einen gewichteten Durchschnitt zur Bestimmung der Pixelfarbe und liefert normalerweise bessere Ergebnisse als die einfache Mittelungsmethode für das Downsampling. Die bikubische Methode ist die langsamste, jedoch präziseste Methode und führt zu den feinsten tonlichen Abstufungen.

**Subsampling to:** Wählt ein Pixel in der Mitte des Beispielbereichs aus und ersetzt den gesamten Bereich mit der angegebenen Auflösung durch dieses Pixel. Die Kurzberechnung verkürzt im Vergleich zur Neuberechnung die Konvertierungsdauer beträchtlich, führt jedoch zu weniger feinen bzw. regelmäßigen Bildern.
...
**Anti-Alias To Gray:** Glättet gezackte Ränder in Schwarzweißbildern. Wählen Sie „2 Bit“, „4 Bit“ oder „8 Bit“, um 4, 16 oder 256 Graustufen anzugeben. (Dieses Verfahren kann bewirken, dass kleine Schriftgrade oder dünne Linien unklar aussehen.)
...
**Farbe unverändert lassen:** Lässt geräteabhängige Farben unverändert und behält geräteunabhängige Farben als nächstmögliche Entsprechung im PDF bei. Diese Option eignet sich für Druckereien, die alle ihre Geräte kalibriert haben, diese Informationen zum Angeben von Farben in der Datei genutzt haben und alle Druckaufträge nur auf diesen Geräten ausgeben.

**Alles für Farbmanagement kennzeichnen:** Bettet beim Destillieren von Dateien ein internationales Farbkonsortiumprofil ein und kalibriert die Farbwerte in den PDF-Dateien, wodurch die Farben in den resultierenden Dateien geräteunabhängig werden, wenn Sie die Kompatibilität mit Acrobat 4 (PDF 1.3) oder höher ausgewählt haben. Geräteabhängige Farbräume in Dateien (RGB, Grayscale und CMYK) werden jedoch in geräteunabhängige Farbräume (CalRGB, CalGray und LAB) konvertiert.

**Nur Bilder für Farbmanagement taggen:** Bettet ICC-Profile nur in Bildern ein, nicht in Text oder Grafiken, wenn Sie die Kompatibilität mit Acrobat 4 (PDF 1.3) ausgewählt haben. Diese Option verhindert, dass schwarzer Text Farbverschiebungen unterzogen wird. Geräteabhängige Farbräume in Bildern (RGB, Grayscale und CMYK) werden jedoch in geräteunabhängige Farbräume (CalRGB, CalGray und LAB) konvertiert. Text und Grafiken werden nicht konvertiert.

**Alle Farben in sRGB konvertieren oder Alle Farben in CMYK konvertieren:** Kalibriert die Farbe in der Datei, wodurch die Farbe geräteunabhängig wird, ähnlich wie &quot;Alles für Farbmanagement kennzeichnen&quot;. Wenn Sie eine Kompatibilität mit Acrobat 4 (PDF 1.3) oder höher ausgewählt haben und eine Konvertierung in sRGB ausführen, werden CMYK- und RGB-Bilder in sRGB konvertiert.
...
**Dokument-Rendering-Intent:** Die Methode zum Zuordnen von Farben zwischen Farbräumen. Das Ergebnis einer bestimmten Methode hängt von den Profilen der Farbräume ab. Einige Profile liefern beispielsweise bei unterschiedlichen Methoden identische Ergebnisse. Die folgenden Optionen stehen zur Auswahl:  
...
**Preserve:** Das bedeutet, dass der Intent im Ausgabegerät und nicht in der PDF-Datei angegeben wird. Bei vielen Ausgabegeräten ist „Relativ farbmetrisch“ die Standardbedingung.

**Wahrnehmungsorientiert:** Behält die relativen Farbwerte der ursprünglichen Pixel bei, während sie der Zielskala zugeordnet werden. Bei dieser Methode bleibt die optische Beziehung zwischen Farben erhalten, obgleich die Farbwerte selbst sich ggf. ändern.
...
**Absolut farbmetrisch:** Deaktiviert die Zuordnung von weißen und schwarzen Punkten beim Konvertieren von Farben. Diese Methode wird nicht empfohlen, es sei denn, Sie müssen Signaturfarben erhalten, z. B. in Warenzeichen oder Logos.
...
**CMYK-Werte für kalibrierte CMYK-Farbräume beibehalten:** Wenn diese Option aktiviert ist, werden geräteunabhängige CMYK-Werte wie geräteabhängige (DeviceCMYK) Werte behandelt, geräteunabhängige Farbräume werden verworfen und PDF/X-1a-Dateien verwenden den Wert Alle Farben in CMYK konvertieren . Falls nicht ausgewählt, werden geräteunabhängige Farbräume in CMYK konvertiert, wenn das Farbmanagement auf „Alle Farben in CMYK konvertieren“ festgelegt ist.
...
**Wenn Übertragungsfunktionen gefunden werden:** Bestimmt, was zu tun ist, wenn Übertragungsfunktionen gefunden werden:

**Preserve:** Behält die Übertragungsfunktionen bei, die traditionell zum Ausgleich von Tonwertzuwachs oder Tonwertverlust verwendet werden, die auftreten können, wenn ein Bild auf einen Film übertragen wird. Ein Tonwertzuwachs erfolgt, wenn die Druckfarbpunkte, die ein gedrucktes Bild bilden (z. B. aufgrund der Verteilung auf Papier) größer als im Halbtonraster sind. Zu einem Tonwertverlust kommt es, wenn die Punkte kleiner gedruckt werden. Bei dieser Option werden die Übertragungsfunktionen als Teil der Datei beibehalten und auf die Datei angewendet, sobald diese ausgegeben wird.

**Anwenden:** Behält die Übertragungsfunktion nicht bei, wendet sie jedoch auf die Datei an, wodurch die Farben in der Datei geändert werden. Diese Option ist nützlich, um Farbeffekte in einer Datei zu erstellen. In der Standardeinstellung ist diese Option für neue Einstellungen aktiviert.
...
**PostScript XObjects zulassen:** PostScript XObjects speichern Informationen, die auf vielen Seiten derselben Datei angezeigt werden, z. B. ein Hintergrundbild oder Kopf- und Fußzeileninformationen. Das Verwenden von PostScript XObjects kann zu einem schnelleren Druck führen, belegt aber mehr Druckerspeicher. Um das Erstellen von PostScript XObjects zu verhindern, deaktivieren Sie diese Option, wenn Sie PDF-Dateien mit einer Kompatibilität mit Acrobat 5 (PDF 1.4) oder höher erstellen.

**Verläufe in weiche Schattierungen konvertieren:** Konvertiert Mischungen in glatte Schattierungen für Acrobat 4 und höher, wodurch PDF-Dateien kleiner werden und die endgültige Ausgabequalität potenziell verbessert wird. PDF Generator konvertiert Farbverläufe aus Adobe Illustrator, Adobe InDesign, Adobe Freehand MX, CorelDraw, Quark XPress und Microsoft PowerPoint.

**Glatte Linien in Kurven konvertieren:** Reduziert die Anzahl der Steuerpunkte, die zum Erstellen von Kurven in CAD-Zeichnungen verwendet werden, was zu kleineren PDF und schnellerem Onscreen-Rendering führt.

**Level 2 Copypage-Semantik beibehalten:** Verwendet den Copypage-Operator, der in LanguageLevel 2 PostScript anstatt in LanguageLevel 3 PostScript definiert ist. Wenn Sie eine PostScript-Datei haben und diese Option aktivieren, kopiert ein Copypage-Operator die Seite. Ist diese Option nicht aktiviert, wird die Entsprechung eines Showpage-Vorgangs ausgeführt, ohne dass der Grafikstatus erneut initialisiert wird.
...
**EPS-Informationen von DSC beibehalten:** Behält Informationen wie die Ausgangsanwendung und das Erstellungsdatum für eine EPS-Datei bei. Ist diese Option deaktiviert, werden die Größe und Mitte der Seite basierend auf der linken unteren Ecke des linken unteren Objekts und der rechten unteren Ecke des rechten unteren Objekts auf der Seite bestimmt.

**OPI-Kommentare beibehalten:** Behält Informationen bei, die erforderlich sind, um ein FPO-Bild (For Placement Only) oder einen Kommentar durch das hochauflösende Bild auf Servern zu ersetzen, die die OPI-Versionen (Open Prepress Interface) 1.3 und 2.0 unterstützen.
...
**Größe der Seite ändern und Grafiken für EPS-Dateien zentrieren:** Zentriert ein EPS-Bild und ändert die Seitengröße, um es näher an das Bild anzupassen. Diese Option gilt nur für Aufträge, die aus einer einzelnen EPS-Datei bestehen.
...
**Wenn weder trimBox noch ArtBox angegeben sind:** Verfügbar, wenn &quot;Compliance Standard&quot;auf der Seite &quot;Standards - Berichterstellung und Kompatibilität&quot;auf eine andere Option als &quot;Ohne&quot;eingestellt ist.

**Als Fehler melden:** Kennzeichnet die PostScript-Datei als nicht kompatibel, wenn eine der Berichtsoptionen ausgewählt ist und auf einer beliebigen Seite ein Endformatrahmen oder ein Kunstfeld fehlt.

**Legen Sie die Endformatrahmen auf MediaBox mit Versätzen fest:** Berechnet Werte in Punkten für das Endformatfeld anhand der Versätze für das Medienfeld der entsprechenden Seiten, wenn weder das Endformatfeld noch das Kunstfeld angegeben ist. Der Endformatrahmen ist stets genau so klein wie oder kleiner als der umgehende Medienrahmen.

**Wenn kein Anschnittrahmen angegeben ist:** Verfügbar, wenn &quot;Compliance Standard&quot;auf der Seite &quot;Standards - Berichterstellung und Kompatibilität&quot;auf eine andere Option als &quot;Ohne&quot;eingestellt ist.

**Anschnittrahmen auf MediaBox festlegen:** Verwendet die Medienfeldwerte für den Anschnittrahmen, wenn der Anschnittrahmen nicht angegeben ist.

**Anschnittrahmen auf Endformatrahmen mit Versätzen festlegen:** Berechnet Werte in Punkten für den Anschnittrahmen basierend auf den Versatzwerten für den Endformatrahmen der jeweiligen Seiten, wenn der Anschnittrahmen nicht angegeben ist. Der Anschnittrahmen ist stets genau so groß wie oder größer als der umgehende Endformatrahmen.

**Standardwerte, falls nicht im Dokument angegeben:** Diese Option ist verfügbar, wenn auf der Seite &quot;Standards - Berichterstellung und Kompatibilität&quot;die Option &quot;Compliance Standard&quot;auf eine andere Option als &quot;Ohne&quot;gesetzt ist.

**Profilname des AusgabeIntent:** Gibt die gekennzeichnete Druckbedingung an, für die das Dokument vorbereitet wurde. Wenn in einem Dokument keine Ausgabebedingung angegeben ist, verwendet PDF Generator den in diesem Menü ausgewählten Wert. Sie können einen der angebotenen Namen auswählen oder in das vorgesehene Feld einen Namen eingeben. Wenn Ihr Workflow erfordert, dass das Dokument die Ausgabebedingung angibt, wählen Sie „Ohne“ aus. Dokumente, die nicht die Anforderung erfüllen, bestehen nicht die Kompatibilitätsprüfung.

**Kennung der Ausgabebedingung:** Gibt den Referenznamen an, der von der Registry des Profilnamens für den Ausgabezweck angegeben wird.
...
**Registrierungsname (URL):** Gibt die Webadresse an, unter der weitere Informationen zur Registrierung angezeigt werden. Der URL wird für ICC-Registrierungsnamen automatisch eingegeben.
...
**Wenn nicht konform:** Gibt an, ob die PDF-Datei erstellt werden soll, wenn die PostScript-Datei die PDF/A-Anforderungen nicht erfüllt.

**Weiter:** Erstellt eine PDF-Datei, selbst wenn die PostScript-Datei die Standardanforderungen nicht erfüllt.

**Auftrag abbrechen:** Erstellt nur dann eine PDF-Datei, wenn die PostScript-Datei die PDF/A-Anforderungen erfüllt und ansonsten gültig ist.

**Profilname des AusgabeIntent:** Gibt die gekennzeichnete Druckbedingung an, für die das Dokument vorbereitet wurde, und ist für die PDF/A-Konformität erforderlich. Wenn Ihr Workflow es erfordert, dass das Dokument die Ausgabebedingung angibt, wählen Sie „Ohne“ aus. Das Dokument wird bei der Kompatibilitätsüberprüfung fehlschlagen, wenn diese Informationen nicht bereitgestellt werden.
...
**Seitenlayout:** Bestimmt, ob das Dokument im Modus &quot;Einzelseiten&quot;, &quot;Vorderseite&quot;, &quot;Fortlaufende Seite&quot;oder &quot;Fortlaufende Seite&quot;angezeigt wird.

**Vergrößerung:** Legt den Zoomfaktor fest, der zum Anzeigen des Dokuments beim Öffnen verwendet wird. Die Standardeinstellung verwendet den vom Benutzer in den Acrobat- oder Adobe Reader-Voreinstellungen festgelegten Vergrößerungswert.
...
**Fenstergröße auf Anfangsseite ändern:** Passt das Dokumentfenster gemäß den Optionen, die Sie unter &quot;Dokumentoptionen&quot;ausgewählt haben, an die Öffnungsseite an.

**Fenster auf Bildschirm zentrieren:** Positioniert das Fenster in der Mitte des Bildschirmbereichs.

**Im Vollbildmodus öffnen:** Maximiert das Dokumentfenster und zeigt das Dokument ohne Menüleiste, Symbolleiste oder Fenstersteuerelemente an.
