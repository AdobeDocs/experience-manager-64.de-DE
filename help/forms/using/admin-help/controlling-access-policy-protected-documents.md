...
Diese Funktion ist nützlich, wenn mehrere Benutzer zusammenarbeiten und verschiedene Versionen desselben Dokuments speichern. Document Security kann die verschiedenen Iterationen verfolgen. Sie können daher Dokumentinformationen für die verschiedenen Versionen einfach anzeigen.
...
Wenn Sie bei den meisten Nicht-Adobe PDF-Viewern ein durch Document Security geschütztes Dokument öffnen, wird entweder die erste Seite als leere Seite angezeigt oder die Anwendung wird abgebrochen, ohne das Dokument zu öffnen.
