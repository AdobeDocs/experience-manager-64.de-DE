...
Sie können auch einen täglichen Synchronisierungszeitplan festlegen, um die User Management-Datenbank automatisch mit Änderungen oder Aktualisierungen an den Quellordnerservern zu synchronisieren. Beachten Sie jedoch, dass dieser Prozess Netzwerk- und Serverressourcen verwendet. Wählen Sie Zeiträume mit geringer Auslastung aus und vermeiden Sie die Planung unnötiger Synchronisierungen, die System- und Netzwerkressourcen binden. Um unnötige Synchronisierungen zu minimieren, verwenden Sie stattdessen die sofortige Synchronisierungsoption.
