...
Eine frühere Version von Acrobat kann kein PDF-Dokument mit einer höheren Kompatibilitätseinstellung öffnen. Wenn Sie beispielsweise die Option Acrobat 7.0 And Later auswählen, können Sie das Dokument nicht in Acrobat 6.0 oder früher öffnen.
