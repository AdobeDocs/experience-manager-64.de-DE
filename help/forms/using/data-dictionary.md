...
Installieren Sie das [Kompatibilitätspaket](https://helpx.adobe.com/in/experience-manager/6-4/forms/using/compatibility-package.html), um die Option **Datenwörterbücher** auf der Seite **Formulare** anzuzeigen.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>elementType</td> 
   <td>Zeichenfolge</td> 
   <td>Erforderlich. Der Typ des DDE: STRING, NUMBER, DATE, Boolean, COMPOSITE, SAMMLUNG.</td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  <tr> 
   ...
   <td><p>DDI (Datentyp für Instanzwert)<br /> </p> </td> 
  </tr> 
  <tr> 
