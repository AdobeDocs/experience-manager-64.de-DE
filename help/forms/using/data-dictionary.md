...
Correspondence Management uses the back end, customer, `` ``or recipient-specific data stored according to the data dictionary’s structure to create correspondence meant for different customers. Beispielsweise kann ein Dokument mit Anzeigenamen wie „Lieber {Vorname}“, „Herr {Nachname}“ erstellt werden.
...
1. (Optional) Nach der Auswahl eines Elements können Sie auf der Registerkarte „Erweitert“ Eigenschaften (Attribute) hinzufügen. You can also tap **Add Field** and extend the properties of a DD element.
...
1. Tap **OK** in the alert message. Eine XML-Datei wird heruntergeladen.
