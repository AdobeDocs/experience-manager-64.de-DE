...
Stellen Sie sicher, dass die entsprechende Person registriert ist, um die relevanten [Zertifizierungsprüfungen](https://training.adobe.com/certification/exams.html#p=1&amp;solution=adobeExperienceManager).
...
Die [Anfangsschätzungen](#project-efforts-initial-estimates) wurden auf hoher Ebene erstellt und entsprechen den allgemeinen Anforderungen für die Implementierung.
