...
Führen Sie die folgenden Schritte aus, um das Linktracking-Verhalten der Adobe Analytics-Integration zu untersuchen. Die Verfahren zeigen Ergebnisse aus [Adobe Experience Cloud Debugger](https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html).
...
1. Aktivieren **Benutzerspezifische Linktracking** , um die Linktracking-Konfiguration des Adobe Analytics-Frameworks zu überschreiben und das Linktracking für den aktuellen Link zu aktivieren.
