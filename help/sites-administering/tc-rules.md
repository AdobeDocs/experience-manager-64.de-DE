...
>[!NOTE]
>
>Nach einer Aktualisierung auf 6.4 wird empfohlen, die Datei aus /etc zu verschieben. Weitere Informationen finden Sie unter [Allgemeine Repository-Neustrukturierung in AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) .
...
Im Editor können Sie **I`s Deep`** auf der Registerkarte **Filter** aktivieren/deaktivieren.
