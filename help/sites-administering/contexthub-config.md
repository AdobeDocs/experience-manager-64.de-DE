...
Verwenden Sie das Verfahren unter [Hinzufügen eines UI-Moduls](/help/sites-administering/contexthub-config.md#adding-a-ui-module) , um das UI-Modul einem vorhandenen UI-Modus hinzuzufügen, z. B. dem Perona-UI-Beispielmodus. Verwenden Sie für das UI-Modul die folgenden Eigenschaftswerte:
