...
1. Klicken Sie auf **Mit Target verbinden**, um die Verbindung mit Target zu initialisieren. Bei erfolgreicher Verbindung wird die Meldung** Verbindung erfolgreich** angezeigt. Klicken Sie auf **OK** und dann auf **OK.**
...
1. Geben Sie im Dialogfeld &quot;Framework erstellen&quot;einen **Titel**, wählen Sie das **Adobe Target Framework** und klicken Sie auf **Erstellen**.
   ...
   Die Framework-Seite wird geöffnet. Sidekick stellt Komponenten bereit, die Informationen aus dem [Client-Kontext](/help/sites-administering/client-context.md) oder [ContextHub](/help/sites-administering/contexthub-config.md) darstellen, den Sie zuordnen können.
