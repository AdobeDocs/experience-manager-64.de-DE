...
>[!NOTE]
>
>Alle Kampagneninhalte sollten unter einer `master`-Seite vom Typ `cq/personalization/components/ambitpage` erstellt werden. Wenn Sie beispielsweise eine Kampagnenstruktur in etwa planen:
>
