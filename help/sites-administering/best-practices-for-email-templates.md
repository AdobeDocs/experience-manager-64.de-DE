...
>[!NOTE]
>
>Alle Kampagneninhalte sollten unter einer `master` Seite des Typs `cq/personalization/components/ambitpage`. Wenn Sie beispielsweise eine Kampagnenstruktur in etwa planen:
>
