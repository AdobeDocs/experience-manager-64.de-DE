...
>[!NOTE]
>
>Der gesamte Inhalt der Kampagne sollte unter einer `master` Seite des Typs erstellt werden `cq/personalization/components/ambitpage`. Wenn Sie z. B. eine Kampagne planen, sieht das folgendermaßen aus:
>
