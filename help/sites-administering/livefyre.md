...
1. Installieren Sie das heruntergeladene Paket aus Package Manager. Anweisungen zur Verwendung der Softwareverteilung und der Pakete in AEM finden Sie unter [Wie mit Paketen](/help/sites-administering/package-manager.md) gearbeitet wird.
