...
1. Laden Sie das Livefyre-Paket von der [Softwareverteilung](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html)herunter.

1. Installieren Sie das heruntergeladene Paket aus Package Manager. Anweisungen zur Verwendung der Softwareverteilung und der Pakete in AEM finden Sie unter [Arbeiten mit Paketen](/help/sites-administering/package-manager.md).
