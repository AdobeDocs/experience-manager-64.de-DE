...
* **Seiten-Editor (Dynamic Media Classic  [zuvor Scene7] -Suche)**:
   ...
   Diese Konfiguration definiert die Optionen, die beim Suchen nach Dynamic Media Classic-Ressourcen im Assets-Browser verfügbar sind (beim Bearbeiten einer Seite).
