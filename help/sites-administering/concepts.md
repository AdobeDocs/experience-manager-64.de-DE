...
Es gibt eine Seite, auf der Sie Ihre Kontodaten leicht verwalten können. Sie können darauf zugreifen, indem Sie auf **Mein Konto** oben auf einer Geometrixx-Seite oder durch Navigieren zu `/content/geometrixx-outdoors/en/user/account.html`.
