...
1. Erstellen Sie ein Profil auf Ihrer AEM Assets-Instanz mithilfe der Anwendungs-ID.
...
1. Geben Sie im Feld **[!UICONTROL Mandanten-URL]** die URL für AEM Assets ein.
   ...
   >[!CAUTION]
   >
   >Due to rebranding, if you entered the Tenant URL as **https://&lt;tenant_id>.marketing.adobe.com** you need to change it to **https://&lt;tenant_id>.experiencecloud.adobe.com.** Um dies zu erreichen, gehen Sie wie folgt vor:
