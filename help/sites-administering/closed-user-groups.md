 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p>Siehe auch <a href="/help/sites-administering/closed-user-groups.md#configuration-options" target="_blank">Konfigurationsoptionen</a> weiter unten.</p> </td> 
  </tr> 
  <tr> 
...
Bei der neuen Implementierung wird die Zugriffssteuerungseinrichtung des Standardautorisierungsmodells nicht von der Erstellung, Änderung oder Entfernung von CUGs beeinflusst. Stattdessen wird ein neuer Richtlinientyp mit dem Namen `PrincipalSetPolicy` als zusätzlicher Zugriffskontrolle-Inhalt auf den Knoten Zielgruppe angewendet. Diese zusätzliche Richtlinie ist ein untergeordnetes Element des Zielknotens und ist ein gleichrangiges Element des Standardrichtlinienknotens, falls dieser vorhanden ist.
