...
* Installieren Sie auf allen AEM den offiziellen [JDBC-Treiber für MySQL](deploy-communities.md#jdbc-driver-for-mysql)
...
[open](#step-open-sql-file), [execute](#step-execute-sql-script)), um jedes [SQL-Skript](#obtain-sql-scripts) zu installieren. [Aktualisieren Sie](#refresh) bei Bedarf, um die Ergebnisse der Skriptausführung anzuzeigen.
...
* Geben Sie die folgenden Werte ein:
   ...
   * **DBC-Verbindung URIJ **:`jdbc:mysql://localhost:3306/aem63reporting`den Server anstelle von localhost angeben, wenn der MySQL-Server nicht mit dem &quot;this&quot;-AEM
