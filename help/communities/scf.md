...
* Look, Feel und UX
   * JS-Vorlage, CSS und [Javascript erweitern/außer Kraft setzen](client-customize.md#extending-javascript)
...
* So fügen Sie benutzerdefinierte Verarbeitung während der Vorgänge hinzu
   * Eine [OperationExtension](server-customize.md#operationextension-class) schreiben
* So fügen Sie einen neuen benutzerdefinierten Vorgang hinzu
   ...
   * hinzufügen Sie JavaScript-Code, um Ihren Vorgang bei Bedarf von der Clientseite aus aufzurufen.
...
1. Ruft die Factory auf und empfängt ein `SocialComponent`Element, das die Ressource und Anforderung handhaben kann.
...
* CSS-Klassen für die Formatierung getrennt von CSS-Klassen für UX, die von JavaScript gesteuert werden, beibehalten
