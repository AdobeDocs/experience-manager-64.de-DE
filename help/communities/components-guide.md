...
* Ob die Standard-SRP [JSRP](jsrp.md) verwendet wird
...
>[!NOTE]
>
>Wenn die SRP standardmäßig auf [JSRP](jsrp.md) gesetzt ist, ist UGC, der in die Veröffentlichungsinstanz eingegeben wird, nur bei der Veröffentlichung sichtbar und *nicht *ist in der Konsole [Moderation](moderate-ugc.md) auf der Autoreninstanz sichtbar.
