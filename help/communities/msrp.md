...
>[!NOTE]
>
>Die mongoDB-Datenbank, die standardmäßig den Namen `communities` verwendet, sollte nicht auf den Namen einer Datenbank eingestellt werden, die für [Knotenspeicher oder Datenspeicher (Binärspeicher)](../../help/sites-deploying/data-store-config.md) verwendet wird. Siehe auch [Datenspeicherung Elemente in AEM 6](../../help/sites-deploying/storage-elements-in-aem-6.md).
...
Um den Fehler zu beheben, stellen Sie bei Befolgen der Anweisungen für [Installieren von Standard MLS](solr.md#installing-standard-mls) sicher, dass
