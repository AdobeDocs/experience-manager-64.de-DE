...
Dieses Paket gibt es im Tutorial [Erstellen einer Beispielseite](create-sample-page.md) für diejenigen, die nicht warten können, einfach zu springen und spielen!...

So erstellen Sie ein Paket:


* Klicken Sie in **[!UICONTROL CRXDE Lite]** auf das Symbol [Paket](http://localhost:4502/crx/packmgr/)
