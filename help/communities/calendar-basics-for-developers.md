...
Eine Community-Site-Struktur, die die Funktion [Kalender](functions.md#calendar-function) enthält, verfügt über eine konfigurierte c `alendar`Komponente. Die Kalenderfunktion unterstützt die Identifizierung einer [privilegierten Benutzergruppe](users.md#privileged-members-group).
