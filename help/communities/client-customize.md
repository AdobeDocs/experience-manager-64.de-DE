...
>[!CAUTION]
>
>Jeder CSS-Klassenname, dem **scf-js-&amp;ast;** vorangestellt ist, hat eine bestimmte Verwendung im JavaScript-Code. Diese Klassen wirken sich auf den Status einer Komponente aus (z. B. Umschalten von ausgeblendet auf sichtbar) und sollten weder überschrieben noch entfernt werden.
>
>Während scf-js-&amp;ast; -Klassen keinen Einfluss auf Stile haben, können die Klassennamen in Stylesheets mit dem Vorbehalt verwendet werden, dass es, da sie die Status von Elementen steuern, möglicherweise Nebenwirkungen geben kann.
...
Skript-Tags in SCF-Skripten sollten beim Überlagern oder Überschreiben von Komponenten nicht entfernt werden. SCF-Skript-Tags, die automatisch zum Einfügen von JSON in HTML erstellt werden, werden mit dem Attribut `data-scf-json=`true gekennzeichnet.
...
* /etc/clientlibs/social/hbs/&lt;Komponentenname>
