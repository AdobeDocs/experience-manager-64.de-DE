...
1. Wählen Sie in der globalen Navigation **[!UICONTROL Tools > Cloud Services > Facebook Social-Anmeldekonfiguration]** aus.
...
1. Wählen Sie in der globalen Navigation **[!UICONTROL Tools > Cloud Services > Twitter Social-Anmeldekonfiguration]** aus.
1. Wählen Sie die Konfiguration **[!UICONTROL Kontextpfad]** aus.
...
1. Erstellen/Bearbeiten Sie die Konfiguration des Twitter-Cloud-Service.
   ...
   * **[!UICONTROL Titel]**  (*Erforderlich*) Geben Sie einen Anzeigetitel ein, der die Twitter App identifiziert. Es wird empfohlen, für die Twitter-App denselben Namen zu verwenden, der als *Anzeigename* eingegeben wurde.

   * **[!UICONTROL Consumer Key]**  (*erforderlich*) Geben Sie den  **Consumer (API)-** Schlüssel für die Twitter-App ein. Dadurch wird die [Adobe Granite OAuth Application and Provider](https://helpx.adobe.com/experience-manager/6-3/communities/using/social-login.html#AdobeGraniteOAuthApplicationandProvider)-Instanz identifiziert, die aus dem Dialogfeld erstellt wurde.

   * **[!UICONTROL Consumer Secret]**  (*erforderlich*) Geben Sie den  ***Consumer (API)-*** Sekretariat für die Twitter App ein.
   ...
   * **[!UICONTROL Benutzer-]** IDs maskierenDeaktivieren Sie diese Option.
...
**&amp;ast;** Ersetzen Sie für  **** nameoauthid-*123*  *123*  durch den Facebook  ***App*** ID- oder Twitter  ***Consumer (API)-*** Schlüssel, der den Wert der  **Client-** ID in der  [Adobe Granite OAuth Application und der ](social-login.md#adobe-granite-oauth-application-and-provider)Provider-Konfiguration darstellt.
