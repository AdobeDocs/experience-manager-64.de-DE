...
1. Wählen Sie das Stiftsymbol aus, das zur Bearbeitung geöffnet werden soll.
   ...
   * **[!UICONTROL Benutzer]** aktualisieren Wenn aktiviert, werden die Benutzerdaten im Repository bei jeder Anmeldung aktualisiert, um Änderungen am Profil oder angeforderte zusätzliche Daten widerzuspiegeln. Die Option &quot;Standard&quot;ist deaktiviert.
...
1. Konfiguration des Twitter-Cloud-Dienstes erstellen/bearbeiten.
   ...
   * **[!UICONTROL Consumer secret]** (*Erforderlich*) Geben Sie den geheimen ***Consumer(API)-Schlüssel*** für die Twitter-App ein.
...
* Stellen Sie sicher, dass der [Adobe Granite OAuth Authentication Handler](#adobe-granite-oauth-authentication-handler) in allen Instanzen im Veröffentlichungsmodus aktiviert wurde
...
**&amp;ast;** Ersetzen Sie für den **Namen** oauthid-*123* den Wert *123* durch die Facebook- ***App-ID*** oder den Twitter-API-Schlüssel ( ***API), der den Wert*** **** [](social-login.md#adobe-granite-oauth-application-and-provider)der in der Konfiguration vonClient-IDsAdobe Granite Outh Application und die Konfiguration von Plugin Provider darstellt.
