...
* **Lösungen**:
   ...
   * Add `?` to the end of the page URL. For example:
      ...
      Dadurch wird die Seite direkt von AEM abgerufen und der Dispatcher wird umgangen. Wenn Sie die aktualisierte Seite erhalten, ist dies ein Hinweis darauf, dass Sie den Dispatcher-Cache löschen sollten.
