...
1. [Kampagne erstellen](#creating-a-new-campaign) Erlebnisse zu speichern; z. B. Teaser-Seiten oder einen Newsletter.
...
* Beim Erstellen eines Teasers:
   ...
   1. [Hinzufügen von Inhalten zu Ihrem Teaser](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#addingcontenttoyourteaser).
...
* Beim Erstellen eines Adobe Target-Angebots (ehemals Test&amp;Target):
   ...
   1. [Erstellen eines Adobe Target-Angebotserlebnisses](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md#creatingatesttargetofferexperience).
...
1. Öffnen Sie die **MCM** und wählen Sie **Kampagnen** im linken Bereich.

1. Auswählen **Neu...** , um **Titel** und **Name** und der Vorlage, die für Ihre neue Marke verwendet werden soll:
...
1. Klicken **Neu...** und geben Sie die **Titel**, **Name** und der Vorlage, die für Ihre neue Kampagne verwendet werden soll.
...
* **Cloud Services:** Die Kampagnenkonfigurationen für Cloud Service. (Siehe [Integration mit Adobe Marketing Cloud](/help/sites-administering/marketing-cloud.md).
...
1. Von **Kampagnen** auswählen. Wählen Sie im rechten Bereich Ihre Kampagne aus und klicken Sie auf **Eigenschaften**.
...
1. Klicken Sie auf **Neu**. Die **Neu erstellen** geöffnet.
...
1. Im **Instrumente** Menü auswählen **Leads importieren**.
...
1. Klicken Sie auf **Bearbeiten**. Die **Lead bearbeiten** geöffnet.
...
1. Aktivieren Sie in der Liste das Kontrollkästchen neben der Liste, die Sie bearbeiten möchten, und klicken Sie auf **Bearbeiten**. Die **Liste bearbeiten** geöffnet.
