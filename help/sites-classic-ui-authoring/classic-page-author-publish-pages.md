...
1. Öffnen Sie die Konsole **Tools**, indem Sie sie auf der Seite **Willkommen** auswählen und dann mit der Dublette auf **Replikation** klicken, um die Konsole zu öffnen ( `http://localhost:4502/etc/replication.html`).
