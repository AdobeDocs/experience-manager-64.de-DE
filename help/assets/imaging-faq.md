...
seo-title: Intelligente Bildbearbeitung
...
* PNG-Anforderungen zum Abrufen verlustfreier Bilder.
* JPEG-Anforderungen in einer Reihe von Qualitätseinstellungen.
* JPEGXR-Anforderungen in einer Reihe von Qualitätseinstellungen.
* JPEG2000-Anforderungen in einer Reihe von Qualitätseinstellungen.
* WEBP fordert eine Reihe von Qualitätseinstellungen an.
...
* Wenn Sie dynamische Medien verwenden, befolgen Sie die Anweisungen zum [Konfigurieren der Bildeinstellungen](config-dynamic.md) für dynamische Medien Legen Sie den **[!UICONTROL Ablaufwert]** auf 24 Stunden oder länger fest.
...
1.  Optional: Sie haben die Möglichkeit, Smart Imaging in Staging zu testen, bevor Adobe die neue Funktion an die Produktion weitergibt.
