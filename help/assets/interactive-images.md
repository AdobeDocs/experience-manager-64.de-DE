...
1. **Hochladen eines Bild-Banners** : Laden Sie Bildbanner hoch, die interaktiv sein sollen.

   Siehe [Hochladen eines Bildbanners](#uploading-an-image-banner).

1. **Hinzufügen von Hotspots zu einem Bild-Banner** : Hinzufügen einem oder mehreren Hotspots zu einem Bild-Banner und verknüpfen Sie jedes mit einer Aktion wie einem Hyperlink, einer QuickView oder einem Erlebnisfragment. Nachdem Sie Hotspots hinzugefügt haben, schließen Sie diese Aufgabe ab, indem Sie das interaktive Bild veröffentlichen.
...
1. **Hinzufügen eines interaktiven Bildes zu Ihrer Website oder Ihrer Website in AEM**

   * Wenn Sie AEM Sites, AEM eCommerce oder beides verwenden, können Sie das interaktive Bild direkt zu einer Webseite in AEM hinzufügen, indem Sie die Komponente Interaktive Medien auf die Seite ziehen. Siehe [Hinzufügen von Dynamic Media-Assets zu Seiten](adding-dynamic-media-assets-to-pages.md).
   * .
...
* Um alle ausgehenden HTTP-Anforderungen in Google Chrome anzuzeigen, drücken Sie F12, um das Bedienfeld **[!UICONTROL Entwicklerwerkzeuge]** zu öffnen, und klicken Sie dann auf die Registerkarte **[!UICONTROL Netzwerk]**.

   Drücken Sie auf einem Mac **[!UICONTROL Befehl+Option+I]**, um das Bedienfeld **[!UICONTROL Entwicklerwerkzeuge]** zu öffnen, und klicken Sie dann auf die Registerkarte Netzwerk.

* In Firefox können Sie entweder das Firebug-Plugin aktivieren, indem Sie F12 drücken und die zugehörige Registerkarte &quot;Net&quot;verwenden, oder Sie können das integrierte **[!UICONTROL Inspector]**-Tool und dessen **[!UICONTROL Netzwerk]**-Registerkarte verwenden.

   Drücken Sie auf einem Mac **[!UICONTROL Befehl+Option+I]**, um das Bedienfeld **[!UICONTROL Entwicklerwerkzeuge]** zu öffnen, und klicken Sie dann auf die Registerkarte **[!UICONTROL Inspektor]**.
     ...
     <tbody> 
      ...
      <tr> 
       ...
       <td><p>Die aufgezeichneten Schnellansichts-URLs enthalten Folgendes:</p> 
        ...
        </ul> <p>In diesem Fall liegen zwei abweichende Teile in der URL vor. Die SKU wird im Parameter <code>prodId</code> und der Kategorien-ID gespeichert</p><p><code>categoryId</code></p><ul><li><p><code>305466</code><code>categoryId</code><code>1100004</code></p></li><li><p><code>310181</code><code>categoryId</code><code>1100004</code></p></li><li><p><code>308706</code><code>categoryId</code><code>1740148</code></p></li></ul><p></p></td></tr></tbody></table></td></tr><tr></tr></table>
...
Sie können die im Lieferumfang von AEM Assets enthaltene standardmäßige interaktive Bild-Viewer-Vorgabe mit dem Namen **[!UICONTROL Shoppable_Banner]** verwenden. Sie können auch eine eigene benutzerdefinierte Viewer-Vorgabe für interaktive Bilder erstellen.
...
Nach dem Speichern der Viewer-Vorgabe wird sie auf der Seite **[!UICONTROL Viewer-Vorgabe]** Liste in AEM Assets automatisch aktiviert (aktiviert). Diese Funktionalität bedeutet, dass sie in der interaktiven Medienkomponente sowie dann sichtbar ist, wenn Sie ein Asset anzeigen. Um jedoch &lt; a0/>ein interaktives Banner mit dieser Viewer-Vorgabe bereitzustellen, müssen Sie *publish* auch Ihre Viewer-Vorgabe veröffentlichen (dies gilt für benutzerdefinierte oder vordefinierte Viewer-Vorgaben).**
...
1. Geben Sie im Dialogfeld **[!UICONTROL Neue Viewer-Vorgabe]** einen Namen ein, um die Vorgabe für den interaktiven Banner-Viewer zu beschreiben.

   Dieser Titel wird nach dem Speichern auf der Seite **[!UICONTROL Viewer-Vorgabe]** Liste angezeigt.
1. Wählen Sie im Pulldown-Menü **[!UICONTROL Rich Media Type]** **[!UICONTROL Interaktives Bild]**.
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Um ein eigenes Hotspot-Bild hochzuladen, das Sie für Bilder verwenden möchten, tippen Sie auf das Symbol **[!UICONTROL Asset-Auswahl]**. Navigieren Sie auf der Seite **[!UICONTROL Inhalt auswählen]** zum gewünschten Hotspot-Bild, wählen Sie es aus und tippen Sie dann auf das Symbol **[!UICONTROL Markierung]** in der oberen rechten Ecke.
   * Um ein vordefiniertes Hotspot-Bild auszuwählen, tippen Sie auf das Symbol **[!UICONTROL Hotspot-Galerie]**. Tippen Sie auf der Palette &quot;Hotspot-Galerie&quot;auf das gewünschte Hotspot-Bild.
...
Sie können einem Bild-Banner Hotspots hinzufügen, indem Sie den Editor auf der Seite **[!UICONTROL Hotspot-Verwaltung]** verwenden.
...
Wenn Sie mit der Erstellung des interaktiven Bilds fertig sind, können Sie mit **[!UICONTROL Vorschau]** eine Darstellung der Darstellung Ihres interaktiven Bilds für Ihre Kunden anzeigen.
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Tippen Sie auf das Bild, um es auf der Ansicht **[!UICONTROL Detail]** zu öffnen. Tippen Sie in der Symbolleiste auf **[!UICONTROL Bearbeiten]**.

1. Tippen Sie in der oberen linken Ecke der Seite auf **[!UICONTROL Hinzufügen Hotspot]** (Tippen mit dem Finger), um die Seite **[!UICONTROL Hotspot-Verwaltung]** zu öffnen.
...
d. (Optional) Um einen Hotspot zu löschen, wählen Sie ihn im Bild aus und tippen Sie dann unter der Überschrift **[!UICONTROL Hotspots]** auf **[!UICONTROL Löschen]** (Garbage can-Symbol).

1. Geben Sie im Textfeld **[!UICONTROL Name]** den Namen des Hotspots ein. Dieser Name wird auch in der Dropdown-Liste **[!UICONTROL Ausgewählter Hotspot]** angezeigt.
1. Führen Sie einen der folgenden Schritte aus:

   * Tippen Sie auf **[!UICONTROL Schnellansicht]**.

      * Wenn Sie AEM Sites- oder eCommerce-Kunde sind, tippen Sie auf das Symbol **[!UICONTROL Produktauswahl]** (Lupe), um die Seite **[!UICONTROL Produkt auswählen]** zu öffnen. Tippen Sie auf das gewünschte Produkt und dann auf **[!UICONTROL Wählen Sie]** in der oberen rechten Ecke der Seite, um zur Seite **[!UICONTROL Hotspot-Verwaltung]** zurückzukehren.
      * Wenn Sie *kein* AEM Sites- oder eCommerce-Kunde sind, gehen Sie wie folgt vor:
         ...
         * Geben Sie anschließend manuell den SKU-Wert ein. Geben Sie im Textfeld **[!UICONTROL SKU-Wert]** die SKU (Stock Keeping Unit) des Produkts ein, die eine eindeutige Kennung für jedes einzelne Produkt oder jede Dienstleistung darstellt, das bzw. die Sie Angebot haben. Der variable Teil der Schnellansichtsvorlage wird automatisch mit dem eingegebenen SKU-Wert ausgefüllt, sodass das System den Hotspot, auf den getippt wird, mit der Schnellansicht einer bestimmten SKU verbinden kann.
   ...
   * Tippen Sie auf **Experience Fragment**.
      ...
      * Wenn Sie AEM Sites-Kunde sind, tippen Sie auf das Symbol **[!UICONTROL Suchen]** (Lupe), um die Seite **[!UICONTROL Erlebnisfragment]** zu öffnen. Tippen Sie auf das Erlebnisfragment, das Sie verwenden möchten, und tippen Sie dann oben rechts auf der Seite auf **[!UICONTROL Auswählen]**, um zur Hotspot-Verwaltungsseite zurückzukehren.
...
1. Tippen Sie links oben auf der Seite &quot;Vorschau&quot;in der Dropdown-Liste **[!UICONTROL Content]** auf **[!UICONTROL Viewers]**.
1. Tippen Sie in der Liste **[!UICONTROL Viewer]** auf **[!UICONTROL Shoppable_Banner]** oder auf den Namen der von Ihnen erstellten interaktiven Bild-Viewer-Vorgabe.
