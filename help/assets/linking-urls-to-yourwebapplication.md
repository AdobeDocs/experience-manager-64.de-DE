...
seo-title: Verknüpfen von URLs mit einer Webanwendung
description: Verknüpfen von URLs mit einer Webanwendung in dynamischen Medien
seo-description: Verknüpfen von URLs mit einer Webanwendung in dynamischen Medien
...
1. Navigate to the *published* asset whose image preset URL or viewer preset URL you want to copy, and tap the asset to open it.
   ...
   Denken Sie daran, dass URLs nur *nach* der ersten *Veröffentlichung* der Assets kopiert werden können. Darüber hinaus muss die Viewer- oder Bildvoreinstellung auch veröffentlicht werden.
...
1. Blättern Sie auf der Seite **[!UICONTROL Cloud Services]** nach unten zur Überschrift **[!UICONTROL Cloud Services für dynamische Medien]** und tippen Sie dann auf **[!UICONTROL Konfigurationen anzeigen]**.
...
1. Kopieren Sie unter **[!UICONTROL Registrierungs-ID]** den Kundennamen, der im letzten Teil der ID gefunden werden kann.
...
1. On the **[!UICONTROL Dynamic Media Cloud Services Settings]** page, do the following:
   ...
   * Kopieren Sie unter **[!UICONTROL Registrierungs-ID]** den Kundennamen, der im letzten Teil der ID gefunden werden kann. Sie benötigen den kopierten Kundennamen später bei diesen Schritten.
...
1. Je nachdem, welches Videobereitstellungsprotokoll Sie verwenden möchten, kopieren Sie den entsprechenden Protokollselektor. Der kopierte Protokollselektor wird in den nachfolgenden Schritten benötigt.
   ...
   | Von Ihnen verwendetes Videoverteilungsprotokoll | Zu verwendende Protokollauswahl |
   |---|---|
   | HTTP <br> Wenn Sie HTTP (nicht sichere Videobereitstellung) verwenden, stellen Sie sicher, dass Sie in dem zuvor kopierten URL-Wert für den Videodienst HTTPS in HTTP ändern. | `public/` |
   | HTTPS | `public-ssl/` |
