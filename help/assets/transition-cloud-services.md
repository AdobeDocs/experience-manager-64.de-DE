...
1. Klicken Sie in der Symbolleiste auf das Symbol **[!UICONTROL Eigenschaften]**, um die Seite **[!UICONTROL Ordnereigenschaften]** anzuzeigen.
...
1. Suchen Sie den Connector, den Sie installiert haben, unter **[!UICONTROL Services von Drittanbietern]** auf der Seite **[!UICONTROL Cloud Services]**.
...
1. Geben Sie einen Titel und einen Namen für den Connector ein und klicken Sie dann auf **[!UICONTROL Erstellen]**. Der benutzerdefinierte Connector ist in der Liste der Connectoren auf der Registerkarte **[!UICONTROL Cloud Services]** verfügbar, die in Schritt 5 von [Anwendung der Übersetzungsservices](#applying-the-translation-services) beschrieben wird.
1. Führen Sie einen beliebigen Übersetzungsworkflow aus, der unter [Erstellen von Übersetzungsprojekten](translation-projects.md) beschrieben wird, nachdem Sie den benutzerdefinierten Connector angewendet haben. Überprüfen Sie die Details des Connectors in der Kachel **[!UICONTROL Übersetzungszusammenfassung]** des Übersetzungsprojekts in der Konsole **[!UICONTROL Projekte]**.
