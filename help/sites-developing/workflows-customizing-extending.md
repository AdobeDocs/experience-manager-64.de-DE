...
Jede Basiskomponente ermöglicht es Entwicklern von Workflow-Modellen, die folgenden wichtigen Funktionen während des Entwurfs zu konfigurieren:
...
1. Eigenschaften des Knotens konfigurieren `cq:listeners`.
