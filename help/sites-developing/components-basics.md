...
1. `cq:icon` - String-Eigenschaft, die auf ein Standardsymbol in der [Coral UI-Bibliothek](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) verweist und im Komponenten-Browser angezeigt wird
...
( `/libs/foundation/components/download/download.jsp`), wobei `file` der Knotenname der Drop-Zielgruppe in der Bearbeitungskonfiguration der Downloadkomponente steht:
