...
>[!CAUTION]
>
>`<cq:includeClientLib>`, die früher häufig zum Einschließen von Client-Bibliotheken verwendet wurde, wird seit AEM 5.6 nicht mehr unterstützt. [ `<ui:includeClientLib>`](/help/sites-developing/taglib.md#amp-lt-ui-includeclientlib) stattdessen wie oben beschrieben verwendet werden.
...
>[!NOTE]
>
>Statische Ressourcen unter dem Client-Bibliotheksordner müssen sich in einem Ordner befinden, der *resources*. Wenn Sie nicht über die statischen Ressourcen, z. B. Bilder, im Ordner verfügen *resources* kann nicht auf einer Veröffentlichungsinstanz referenziert werden. Im Folgenden finden Sie ein Beispiel: http://localhost:4503/etc.clientlibs/geometrixx/components/clientlibs/resources/example.gif
