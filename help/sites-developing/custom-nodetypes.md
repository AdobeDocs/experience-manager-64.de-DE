...
description: AEM basiert auf Sling und verwendet ein JCR-Repository mit Knotentypen, die von beiden angeboten werden, AEM bietet aber auch eine Reihe benutzerdefinierter Knotentypen
...
* `@prop cq:master` - Pfad des primären Quell-(Kontroll-)Knotens der LiveRelationship.
