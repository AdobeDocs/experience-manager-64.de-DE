...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p><code>String</code></p> <p>optional</p> <p>default: ""</p> </td> 
   <td>Ein Text, der eine Beschreibung der Variante enthält <span>(auf der Registerkarte " <strong>Variation</strong> "(linke Leiste) des Fragmenteditors angezeigt).</span></td> 
  </tr> 
 </tbody> 
</table>
