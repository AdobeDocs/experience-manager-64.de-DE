...
Mit AEM 5.6 hat Adobe eine neue Touch-optimierte Benutzeroberfläche mit [responsivem Design](/help/sites-authoring/responsive-layout.md) für die Autorenumgebung eingeführt. Sie unterscheidet sich deutlich von der ursprünglichen klassischen Benutzeroberfläche, da sie sowohl für Geräte mit Touch-Bedienung als auch für Desktop-Geräte konzipiert ist.
...
Hierfür wird eine Erweiterung des HTML-Vokabulars verwendet, die bereitgestellt wird, damit der Autor seine Absicht zur Erstellung einer interaktiven Web-App erklären kann. Dies ist ein ähnlicher Ansatz wie [WAI-ARIA](https://www.w3.org/TR/wai-aria/) und [Microformats](http://microformats.org/).
...
Die [Verwaltungskomponenten der Granite-Benutzeroberfläche](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/index.html) stellen die Foundation-Komponenten für die Bereitstellung von generischen Bausteinen dar, die von allen Verwaltungsanwendungen implementiert werden können. Dies sind beispielsweise:
