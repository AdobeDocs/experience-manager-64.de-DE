...
Jedes SPA-Projekt auf AEM sollte den [Maven Archetype für SPA Starter Kit](https://github.com/adobe/aem-spa-project-archetype)nutzen.
...
* **[Dynamische Routing](#dynamic-routing)**- Die SPA ist für das Routing zuständig, und AEM überwacht es und ruft die Komponentendaten darauf ab. Jede Route sollte ebenfalls dynamisch sein.

Wenn Sie diese Prinzipien bei der Entwicklung Ihrer SPA beachten, ist diese so flexibel und so zukunftssicher wie möglich, während alle unterstützten AEM-Authoring-Funktionen aktiviert werden.
...
Die SPA sollte nur auf der dynamischen Wiedergabe von Inhalten basieren. Dies ist die Standarderwartung, bei der AEM alle untergeordneten Elemente der Inhaltsstruktur abruft und rendert.
