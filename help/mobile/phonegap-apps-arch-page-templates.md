...
Wie unter [AEM Seitenvorlagen](/help/mobile/apps-architecture.md) beschrieben, kann jede Komponente ein JavaScript-Fragment ausgeben, um den JSON-Inhalt zu verwenden, der durch das Versprechen `data` bereitgestellt wird. Nach Angular-Konventionen sollte ein Controller nur zum Zuweisen von Variablen zum Gültigkeitsbereich verwendet werden.
