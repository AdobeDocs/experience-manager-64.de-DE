...
Optional können Sie vor der Bereitstellung für die Produktion das Adobe-Tool Bloodhound verwenden, um Ihre Analytics-Konfiguration zu testen. Um Ihre Analytics-Konfiguration zu testen, müssen Sie Ihre Datei &quot;ADBMobileConfig.json&quot;so bearbeiten, dass sie auf den Server verweist, auf dem Bloodhound ausgeführt wird, und nicht auf den eigentlichen Analytics-Server. Um diese Änderung vorzunehmen, ändern Sie von Ihrem ADBMobileConfig.json den folgenden Eintrag.
