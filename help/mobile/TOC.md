...
+ Authoring-On-Demand-Dienste-App {#authoring}
   + [Mobile On-Demand](mobile-apps-ondemand.md)
   + [Verwalten von Inhalten](mobile-apps-ondemand-manage-content-ondemand.md)
   + [Veröffentlichung von Inhalten aufheben](mobile-on-demand-publishing-unpublishing.md)
...
+ Entwickeln von Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [Entwickeln von Apps mit der PhoneGap-CLI](phonegap-apps-pg-cli.md)
