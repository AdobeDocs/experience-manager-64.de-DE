...
1. Bearbeiten des On-Demand-Services-Clients für ***Experience Manager***
...
### AEM Mobile On-demand Services CloudService konfigurieren {#configuring-aem-mobile-on-demand-services-cloudservice}

1. Zu Cloud Services

   1. AEM > Tools > Bereitstellung > [CloudServices](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html). Durchsuchen oder Suchen nach ***Adobe Experience Manager Mobile On-Demand-Diensten***
...
Weitere Informationen zum Erstellen von Rollen mit unterschiedlichen Berechtigungen, z. B. zum Erstellen von Apps oder zum Erstellen und Veröffentlichen von Inhalten, finden Sie in der AEM Mobile-Hilfe unter &quot;Benutzerrollen [erstellen und Zugriff](https://helpx.adobe.com/digital-publishing-solution/help/account-admin-dps.html) gewähren&quot;.
...
>
>Weitere Informationen zum AEM Mobile Dashboard finden Sie [hier](/help/mobile/mobile-apps-ondemand-application-dashboard.md).
