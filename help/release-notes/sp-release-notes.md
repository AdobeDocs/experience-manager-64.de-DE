...
* Wenn URLs, die mit `/_jcr_content/.html` oder `/jcr:content/.html` auf die zugegriffen wird, Spitzen der CPU und AEM nicht mehr reagieren (NPR-31755).
...
### WCM-Vorlagen-Editor {#wcm-template-editor-6480}
