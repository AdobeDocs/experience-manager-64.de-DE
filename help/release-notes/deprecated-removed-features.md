...
| Formulare | Die Funktion zum Exportieren von PDF in das PDF/E-1-Format mit PDF Generator wurde entfernt. | PDF Generator unterstützt weiterhin den Export von PDF-Dateien in die Formate PDF/A-1a/b, PDF/A-2a/b und PDF/A-3a/b. |
...
| Communities | Unterstützung für die Captcha-Verifizierung wurde entfernt. | Verwenden Sie zur Verifizierung die benutzerdefinierte Captcha-Integration (z. B. reCAPTCHA von Google). |
