...
1. Erstellen Sie eine Sicherungskopie des Ordners *aem-forms_root*. Dies ist erforderlich, wenn Sie die Schnellkorrektur deinstallieren.
...
Datei `aemforms64_cfp_install.exe`.
...
1. Wählen Sie je nach Anwendungsserver eines der folgenden Dokumente aus und befolgen Sie die Anweisungen im Bereich *Konfigurieren und Bereitstellen von AEM Forms*.
   ...
   * [Installieren und Bereitstellen von AEM für WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64_de)
