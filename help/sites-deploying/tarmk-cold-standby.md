...
1. Wechseln zur Web-Konsole unter: `https://serveraddress:serverport/system/console/configMgr`
...
>
>Gehen Sie dazu wie folgt vor: *http://localhost:4502/system/console/status-slingsettings* und die Überprüfung der **&quot;Ausführungsmodi&quot;** Linie.
...
1. Beenden Sie den Synchronisierungsprozess auf der Cold-Standby-Instanz, indem Sie zur JMX-Konsole navigieren und die **org.apache.jackrabbit.oak: Status (&quot;Standby&quot;)** Bean. Weitere Informationen finden Sie im Abschnitt [Monitoring](#monitoring).
...
1. Wenn die Wartung abgeschlossen und die Instanz neu gestartet wurde, führen Sie die folgenden Schritte aus:
   ...
   * Auf der Standby-Instanz kann die Speicherbereinigung für den Datenspeicher nur über das **BlobGarbageCollection**-MBean – `startBlobGC()` – ausgeführt werden. Die **RepositoryManagement** MBean ist nicht auf der Standby-Instanz verfügbar.
