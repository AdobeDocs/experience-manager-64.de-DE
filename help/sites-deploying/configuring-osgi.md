...
Wenn beispielsweise eine Instanz mit den Ausführungsmodi gestartet wurde `author,dev,emea`, `/apps/*/config.author/` `/apps/*/config.emea.author/` und legen Sie eine Konfiguration für\
