...
* Verwenden Sie Ihre lokale Installation (z. B. `http://localhost:4502/system/console/jcrresolver`), um zu bestimmen, welcher Resource Resolver aktiv ist.
...
>[!CAUTION]
>
>Wenn Sie die Einstellung für **Minimieren** oder **Gzip** Sie müssen auch den Inhalt des Zwischenspeichers clientlibs löschen. Siehe hierzu [Knowledge Base-Artikel](https://helpx.adobe.com/ca/experience-manager/kb/How-to-force-a-recompilation-of-all-Sling-scripts-jsps-java-sightly-on-AEM-6-4.html) für Details.
...
**Day CQ WCM Debug Filter** Dies ist bei der Entwicklung nützlich, da es die Verwendung von Suffixen wie ?debug=layout beim Zugriff auf eine Seite ermöglicht. Beispielsweise liefert http://localhost:4502/cf#/content/geometrixx/de/support.html?debug=layout Layout-Daten, die für den Entwickler von Interesse sein können.
