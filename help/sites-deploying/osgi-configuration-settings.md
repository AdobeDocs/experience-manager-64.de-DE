...
**Day CQ WCM Debug** FilterDies ist nützlich bei der Entwicklung, da es die Verwendung von Suffixen wie ?debug=layout beim Zugriff auf eine Seite ermöglicht. Beispielsweise liefert http://localhost:4502/cf#/content/geometrixx/de/support.html?debug=layout Layout-Daten, die für den Entwickler von Interesse sein können.
