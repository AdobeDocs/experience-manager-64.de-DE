...
Weitere Informationen hierzu finden Sie im Abschnitt [Vorlagendokumentation](/help/sites-developing/templates.md#template-availability).
...
1. Erstellen Sie eine Seite und wählen Sie **Adobe Campaign Classic-Profil** oder **Adobe Campaign Standard-Profil** und klicken Sie auf **Nächste**.

   ![chlimage_1-43](assets/chlimage_1-43.png)

   >[!NOTE]
   >
   >Wenn die gewünschte Vorlage nicht verfügbar ist, lesen Sie [Formularverfügbarkeit](/help/sites-developing/templates.md#template-availability).
...
>[!NOTE]
>
>Wenn die gewünschte Vorlage nicht verfügbar ist, lesen Sie [Verfügbarmachen von Vorlagen](/help/sites-authoring/adobe-campaign.md).
...
1. Auf der Seite im **Formularstart** auf das Symbol Konfiguration.

   ![chlimage_1-46](assets/chlimage_1-46.png)

1. Klicken Sie auf **Erweitert** und wählen Sie den Formulartyp aus: **Abonnieren, Abmelden,** oder **Profil speichern** und klicken Sie auf **OK.** Pro Formular kann nur ein Typ gewählt werden.
...
1. Ziehen Sie die Komponente **Verschlüsselter Primärer Schlüssel** zum Formular (an einer beliebigen Stelle) hinzu und klicken oder tippen Sie auf **Konfiguration** Symbol. Geben Sie auf der Registerkarte **Adobe Campaign** einen Namen für den URL-Parameter an. Klicken oder tippen Sie auf das Häkchen, um die Änderungen zu übernehmen.
...
1. Klicken Sie auf das Symbol für die Konfiguration, um die Komponente zu öffnen. Beispiel: in **Textfeld (Kampagne)** -Komponente, ändern Sie den Titel und den Text.
...
>
>Um diesen Link zu erstellen, verwenden Sie die -Variable **Hauptressourcenkennung**(Adobe Campaign Standard) oder **Verschlüsselte Kennung** (Adobe Campaign Classic) (z. B. in einer **Text und Personalisierung (Kampagne)** -Komponente), die mit dem EPK in Adobe Campaign verknüpft ist.
...
1. So rufen Sie den verschlüsselten Primärschlüssel (EPK) eines Adobe Campaign-Profils ab:
   ...
   * Navigieren Sie in Adobe Campaign Classic zu **Profile und Zielgruppen** >  **Empfänger**, in dem die vorhandenen Profile aufgelistet werden. Stellen Sie sicher, dass in der Tabelle die **Verschlüsselte Kennung** in einer Spalte (dies kann durch Rechtsklick auf einen Eintrag und Auswahl von **Liste konfigurieren..**). Kopieren Sie die verschlüsselte Kennung des gewünschten Profils.
