...
1. Klicken Sie auf die Registerkarte **Erweitert** und wählen Sie den Formulartyp aus: **Abonnieren, Abmelden,** oder **Profil speichern** und klicken Sie auf **OK.** Pro Formular kann nur ein Typ gewählt werden.
