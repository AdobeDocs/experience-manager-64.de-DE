...
* [Formular](#form): Enthält alle für das Erstellen eines Formulars benötigten Komponenten.
...
* **Bild**
   ...
   * **Zuschneiden**
      ...
      Beschneiden Sie ein Bild. Ziehen Sie den Rahmen, um das Bild zu beschneiden.
...
* **Daten**
   ...
   * **Diagrammdaten**
      ...
      Geben Sie die Diagrammdaten mithilfe des CSV-Formats ein; das CSV-Format (kommagetrennte Werte) verwendet ein Komma (,) als Feldtrennzeichen.
...
>[!CAUTION]
>Diese Foundation-Komponente ist veraltet. Adobe empfiehlt stattdessen die Verwendung der [Kernkomponenten](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html). 
...
>[!CAUTION]
>Diese Foundation-Komponente ist veraltet. Adobe empfiehlt stattdessen die Verwendung der [Kernkomponente „Schnellsuche“](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/quick-search.html). 
...
>[!CAUTION]
>Diese Foundation-Komponente ist veraltet. Adobe empfiehlt stattdessen die Verwendung der [Kernkomponente „Text“](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/text.html). 

>[!NOTE]
>
>Die Komponente **Tabelle** basiert auf dem [Rich-Text-Editor](/help/sites-authoring/rich-text-editor.md) - genau wie die Komponente **[Text.](#text)**
>
...
>[!NOTE]
>
>Die Komponente **Text** basiert auf dem [Rich-Text-Editor](/help/sites-authoring/rich-text-editor.md) - genau wie die Komponente **[Tabelle](#table)**.
>
>Die Komponente **Tabelle** sollte für Tabellen verwendet werden, auch wenn diese ebenso mit der Komponente **Text** erstellt werden können.
