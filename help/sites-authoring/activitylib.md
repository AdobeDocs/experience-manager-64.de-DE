...
>
>
**Zusätzlicher Hinweis:** Bei der Option **xt_only** handelt es sich um eine Einstellung, die auf einen bestimmten Target-Mandanten (Clientcode) angewendet wird und nur in Adobe Target bearbeitet werden kann. Sie können diese Option in AEM nicht aktivieren oder deaktivieren.
...
>
>Detaillierte Informationen finden Sie unter [Voraussetzungen für die Integration in Adobe Target](/help/sites-administering/target-requirements.md).
...
* **Zielmetrik:** Wenn Adobe Target als Targeting-Engine ausgewählt ist, können Sie der Aktivität Erfolgsmetriken hinzufügen. Eine Erfolgsmetrik ist erforderlich.
...
1. Tippen/Klicken Sie auf die Marke, für die Sie die Aktivität erstellen, dann auf **Erstellen** und anschließend auf **Aktivität erstellen**. Wählen Sie bei der Bearbeitung die Aktivität im Bildschirm „Masterbereich“ aus und tippen/klicken Sie auf **Aktivität bearbeiten**.
...
1. Select the activity and click or tap **View Properties **and click the **Reports** tab and select the activity that you want to view performance for/convert winning experiences for. Leistungsdaten werden angezeigt.
