...
## Hinzufügen eines Layout-Containers und des Inhalts (Bearbeitungsmodus) {#adding-a-layout-container-and-its-content-edit-mode}
...
* Über das [Menü „Modus“ in der Symbolleiste](/help/sites-authoring/author-environment-tools.md#page-modes) und Auswahl des Modus **Layout**
