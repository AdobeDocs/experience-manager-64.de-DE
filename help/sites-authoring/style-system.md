...
1. Tippen oder klicken Sie auf die Schaltfläche **Stile** in der Symbolleiste der Komponente **Liste**, um das Stilmenü zu öffnen und das Erscheinungsbild der Komponente zu bearbeiten.
   ...
   >[!NOTE]
   >
   >In diesem Beispiel schließen sich die **Layout** stile (**Block** und **Raster**) gegenseitig aus, während die **Anzeige** optionen (**Image** oder **Datum**) miteinander kombiniert werden können. Dies kann [in der Vorlage durch den Vorlagenautor konfiguriert werden](/help/sites-authoring/style-system.md#as-a-template-author).
