...
>[!NOTE]
>
>Der Standardbereich „Masterbereich“ wird standardmäßig ausgeblendet, wenn Sie auf den Namen einer Marke tippen/klicken, **bis** Sie einen anderen Bereich erstellen. Wenn Sie dann eine Marke in der Konsole **Aktivität** oder **Angebote** auswählen, wird die Konsole **Bereich** angezeigt.
...
1. Ist Ihre Seite mit einem Gebiet verknüpft, das eine Live Copy darstellt, wird der Vererbungsstatus angezeigt. Tippen oder klicken Sie auf **Targeting starten**.
1. Wählen Sie in der Symbolleiste aus dem Dropdownmenü die Option **Live Copy trennen**. AEM bestätigt, dass Sie die Live Copy trennen möchten.
