...
1. Möchten Sie den Betreff der E-Mail ändern oder für Benutzer, die die E-Mail nicht im HTML-Format anzeigen, einfachen Text hinzufügen, wählen Sie **E-Mail** aus und fügen Sie Betreff und Text hinzu. Wählen Sie das Seitensymbol aus, um automatisch aus der HTML-Version eine Version mit einfachem Text zu generieren. Klicken Sie nach Abschluss auf das Häkchen.
   ...
   Sie können den Newsletter mithilfe von Adobe Campaign-Personalisierungsfeldern personalisieren. Möchten Sie ein Personalisierungsfeld hinzufügen, klicken Sie auf die Schaltfläche mit dem Adobe Campaign-Logo, um die Auswahl für Personalisierungsfelder zu öffnen. Sie können dann aus allen für diesen Newsletter verfügbaren Feldern auswählen.
...
## AEM mit Adobe Campaign Standard und Adobe Campaign Classic verknüpfen {#linking-aem-with-adobe-campaign-standard-and-adobe-campaign-classic}
...
Mit Adobe Campaign Standard können Sie in AEM erstellte Inhalte abrufen und mit folgenden Elementen verknüpfen:
...
1. Erstellen Sie eine neue E-Mail, die auf einer AEM-spezifischen E-Mail-Vorlage beruht. Weitere Informationen finden Sie unter [Erstellen von E-Mails in Adobe Campaign Standard](https://helpx.adobe.com/de/campaign/standard/channels/using/creating-an-email.html).
...
1. Wählen Sie den Inhalt aus, den Sie in Ihrer E-Mail verwenden möchten.
   ...
   * Alle Inhalte, die bereits mit einem Versand verknüpft sind.
...
Mit Adobe Campaign können Sie in AEM erstellte Inhalte wiederherstellen und synchronisieren mit:
...
>[!NOTE]
Workflow-Schritt **In Adobe Campaign veröffentlichen** ist in AEM 6.1 veraltet. Dieser Schritt war Teil der AEM 6.0-Integration mit Adobe Campaign und ist nicht mehr erforderlich.
