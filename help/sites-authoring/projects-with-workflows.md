...
1. Wählen Sie im Medienprojekt die Schaltfläche **+** in der Kachel **Workflows** und dann **Kopierworkflow anfordern**.
...
1. Wählen Sie im Projekt „Einfach“ in der Kachel **Workflows** die Schaltfläche **+** und dann **Launch-Workflow anfordern**.
