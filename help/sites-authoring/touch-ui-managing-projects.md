...
Das Verfahren zum Erstellen eines Projekts ist für jedes Projekt identisch. Der Unterschied zwischen den Projekttypen umfasst verfügbare [Benutzerrollen](/help/sites-authoring/projects.md) und [Workflows](/help/sites-authoring/projects-with-workflows.md).  So erstellen Sie ein neues Projekt:
...
To toggle between your active and inactive projects, in the **Projects** console, click **Toggle Active Projects**. Wenn neben dem Symbol ein Häkchen zu sehen ist, werden die aktiven Projekte angezeigt.
